...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '808c48ef96f7c2768deee6701653cad3da97f26a' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/router/router_list.tpl',
      1 => 1469707234,
      2 => 'extends',
  ...
  'unifunc' => 'content_57e926bfc87f80_16668218',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57e926bfc87f80_16668218')) {function content_57e926bfc87f80_16668218($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-lg-12">
        <form action="cpanel/router/update-all" method="post" role="form">
            <div class="panel panel-default">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title">
                        ROUTE LIST                        &nbsp;<span class="badge">Zobrazených 1-10 z 2 záznamov</span>
                    </h3>
                ...
                <div class="panel-body panel-body-table">
                            ...
                            <div class="col-lg-12" style="padding:15px 10px;">
                                ...
                                <ul class="pagination pagination-sm pull-right"><li class="disabled"><a href="cpanel/router/0/10?q=womens-sweatpants-wild"onclick="return false;"><i class="fa fa-angle-left"></i></a></li><li class="active"><a href="cpanel/router/1/10?q=womens-sweatpants-wild">1</a></li><li class="disabled"><a href="cpanel/router/2/10?q=womens-sweatpants-wild"onclick="return false;"><i class="fa fa-angle-right"></i></a></li></ul>
                            </div>
                        </div><!-- end row -->
                        <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                            <table id="statusList" class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                                                           <tr style="border-left: 3px solid #b64645;">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="routeList[0]['route-id']" value="8103"/>
                                                1
                                            </td>
                                            ...
                                            <td class="text-left">
                                                <a href="http://www.carpedmfashion.com/womens-sweatpants-wild" target="__blank">
                                                    http://www.carpedmfashion.com/womens-sweatpants-wild                                                </a>
                                            </td>
                                            <td class="text-left">
                                                                                                    <strong>store</strong>
                                                                                            </td>
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="routeList[1]['route-id']" value="8107"/>
                                                2
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-left">
                                                <a href="http://www.carpedmfashion.com/womens-clothing/womens-sweatpants/womens-sweatpants-wild-jeans" target="__blank">
                                                    http://www.carpedmfashion.com/womens-clothing/womens-sweatpants/womens-sweatpants-wild-jeans                                                </a>
                                            </td>
                                            <td class="text-left">
                                                                                                    <strong>store</strong>
                                                                                            </td>
