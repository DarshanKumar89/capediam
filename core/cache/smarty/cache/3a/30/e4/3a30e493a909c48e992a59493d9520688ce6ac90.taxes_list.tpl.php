...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '3a30e493a909c48e992a59493d9520688ce6ac90' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/taxes/taxes_list.tpl',
      1 => 1469707246,
      2 => 'extends',
  ...
  'unifunc' => 'content_58470609438338_93411244',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58470609438338_93411244')) {function content_58470609438338_93411244($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
    <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">TAXES&nbsp;<span class="badge">2</span></h3>
                        <ul class="panel-controls">
                            <li>
                                <a href="#" onclick="return false;" class="panel-collapse">
                                    <span class="fa fa-angle-down"></span>
                            ...
                            <table class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="taxes[0]['tax-id']" value="1"/>
                                                1
                                            </td>
                                            <td class="text-left">DPH SK 20%</td>
                                            <td class="text-center">20.000</td>
                                            <td class="text-center">
                                                <a href="cpanel/store/localization/taxes/edit/1" class="btn btn-block btn-info" title="DPH SK 20%">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="taxes[0]['enable']" checked="" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="taxes[0]['remove']" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="taxes[1]['tax-id']" value="2"/>
                                                2
                                            </td>
                                            <td class="text-left">IVA IT 22%</td>
                                            <td class="text-center">22.000</td>
                                            <td class="text-center">
                                                <a href="cpanel/store/localization/taxes/edit/2" class="btn btn-block btn-info" title="IVA IT 22%">
                                                    <span class="fa fa-pencil"></span>
                                                    &nbsp;Edit
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="taxes[1]['enable']" checked="" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="taxes[1]['remove']" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                        </tr>
