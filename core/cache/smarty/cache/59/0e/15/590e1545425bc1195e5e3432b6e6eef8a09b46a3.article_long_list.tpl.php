<?php /*%%SmartyHeaderCode:208209760557c911c05509b0-90906468%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2a50ac09cb6ac319b6270272ad17ceba7413fce' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/list/article_long_list.tpl',
      1 => 1469707238,
      2 => 'file',
    ),
    ...
    '590e1545425bc1195e5e3432b6e6eef8a09b46a3' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/list/article_long_list.tpl',
      1 => 1469707238,
      2 => 'extends',
  ...
  'nocache_hash' => '208209760557c911c05509b0-90906468',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_57c911c0979255_00427050',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c911c0979255_00427050')) {function content_57c911c0979255_00427050($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel-body-table">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:15px 10px 0 10px;">
                                <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                    <select class="form-control select" onchange="location = 'cpanel/store/catalog/articles/long/1/'+this.options[this.selectedIndex].value;">
                                ...
                                <div class="form-group pull-left" style="width:400px;margin-right:5px;">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" onclick="location = 'cpanel/store/catalog/articles/long/1/10?q='+document.getElementById('search').value;" class="btn btn-default">
                                                <i class="fa fa-search"></i>
                                            </button>
                                        </span>
                                    </div>
                                </div>
                                <ul class="pagination pagination-sm pull-right"><li class="disabled"><a href="cpanel/store/catalog/articles/long/0/0/10"onclick="return false;"><i class="fa fa-angle-left"></i></a></li><li class="active"><a href="cpanel/store/catalog/articles/long/0/1/10">1</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/2/10">2</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/3/10">3</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/4/10">4</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/5/10">5</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/6/10">6</a></li><li class="disabled"><span>...</span></li><li><a href="cpanel/store/catalog/articles/long/0/28/10">28</a></li><li class=""><a href="cpanel/store/catalog/articles/long/0/2/10"><i class="fa fa-angle-right"></i></a></li></ul>
                            </div><!-- end col -->
                        </div><!-- end row -->
                        <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                            <table id="articleList" class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, cotton hoodie with open pockets and large hood.</p>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, cotton, slim-cut sweatpants with pockets and lace on the waist.</p>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, loose, velour hoodie with large hood.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, slim-fit, velour sweatpants with sloping pockets.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Men&#039;s, cotton, harem sweatpants with snap button pockets</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, straight-cut design, cotton sweatpants with pockets.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, elastic, cotton sweatpants with decorative pockets.</p>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, designer sweatpants with jeans applications.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, cotton, stylish hoodie with zipper and with pockets.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator orange">
                                                    <i class="fa fa-bullseye"></i>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;">Women&acute;s, elastic harem sweatpants with pockets.</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator green">
                                                    <i class="fa fa-bullseye"></i>
