...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'e85fa92406395601e6a2e20461899455f3f6bc40' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/delivery/delivery_edit_form.tpl',
      1 => 1474276415,
      2 => 'extends',
  ...
  'unifunc' => 'content_57dfac665a1d63_46531268',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57dfac665a1d63_46531268')) {function content_57dfac665a1d63_46531268($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
  <a href="cpanel/store/delivery-payment/delivery/edit/1">
    Osobn&yacute; odber - Bratislava
  </a>
</li>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <form action="cpanel/store/delivery-payment/delivery/update" method="post" role="form">
      <input type="hidden" name="delivery-id" value="1"/>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input type="text"
                  name="delivery-name"
                  value="Osobn&yacute; odber - Bratislava"
                  class="form-control"
                  required
                />
              </div><!-- end form-group -->
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="5">Riverpark Dance School

Komplex River Park
Dvoř&aacute;kovo n&aacute;brežie 4 &ndash; 10 (n&aacute;brežie Dunaja pri PKO)
811 02 Bratislava
Slovensk&aacute; republika
Telef&oacute;n: +421 (0)2 322 38 116 / +421 (0)910 373 373</textarea>
              </div><!-- end form-group -->
              <div class="form-group">
                <label>
                  Zapnuté
