<?php /*%%SmartyHeaderCode:44181590158791f01c6e945-17253250%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fda520e8f7f39ed5b8894a47978a8bd4855a7ce1' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_list.tpl',
      1 => 1469707232,
      2 => 'file',
    ),
    ...
    'ba6aa33c82015336a9593725eb9650b4aa12071a' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_list.tpl',
      1 => 1469707232,
      2 => 'extends',
  ...
  'nocache_hash' => '44181590158791f01c6e945-17253250',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_58791f02124673_76709972',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58791f02124673_76709972')) {function content_58791f02124673_76709972($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">                                
                        <h3 class="panel-title">
                            <i class="fa fa-list"></i>&nbsp;
                            ZOZNAM STRÁNOK&nbsp;
                            <span class="btn btn-info" style="margin: 0 15px;">18</span>
                            <span class="badge">Zobrazených 1-50 z 18 záznamov</span>
                        </h3>                               
                    </div>
                        ...
                        <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                            <table class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/2" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="MAJK SPIRIT - BIELY PRINC">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[3]['publish']" value="1" >
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/6" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="OĽGA BEST&Auml;NDIGOV&Aacute; - TR&Eacute;NING S KR&Aacute;ĽOVNOU ĽADU ">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/7" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="CARPE DM FASHION - PR&Iacute;BEH TALENTU A V&Aacute;&Scaron;NE">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/12" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="V&scaron;eobecn&eacute; obchodn&eacute; podmienky">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                     ...
                                                     <span></span>
                                                                            ...
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[12]['page-id']" value="15"/>
                                                15
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/15" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="Balada o tepl&aacute;koch">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[12]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[12]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[13]['page-id']" value="16"/>
                                                16
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/16" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="TEPL&Aacute;KOV&Eacute; SPOVEDE">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[13]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[13]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[14]['page-id']" value="17"/>
                                                17
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/17" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="Beach Volley turnaj s CarpeDM">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[14]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[14]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[15]['page-id']" value="18"/>
                                                18
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/18" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="Čo ony maj&uacute; a my nie?!">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[15]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[15]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[16]['page-id']" value="19"/>
                                                19
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/19" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="Carpe DM d&aacute;va &scaron;ancu mlad&yacute;m">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[16]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[16]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
                                                                            <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="pagelist[17]['page-id']" value="20"/>
                                                20
                                            </td>
                                            <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/page-edit/20" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="test">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="pagelist[17]['publish']" value="1" checked="">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                     <input type="checkbox" name="pagelist[17]['remove']" value="1">
                                                     <span></span>
                                                 </label>
                                            </td>
                                        </tr>
