<?php /*%%SmartyHeaderCode:44333271758791548f15b09-06663581%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f707219798e66cbb317ed69ba2e0915e2881e558' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/thumbnail/manage.tpl',
      1 => 1469707249,
      2 => 'file',
    ),
    ...
    'b7276394ccf05be52eb4d89ff5ba7f2f702f24b5' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/thumbnail/manage.tpl',
      1 => 1469707249,
      2 => 'extends',
  ...
  'nocache_hash' => '44333271758791548f15b09-06663581',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_587915494f8b21_29642876',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_587915494f8b21_29642876')) {function content_587915494f8b21_29642876($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                  ...
                  <table id="resizeRuleList" class="table table-bordered table-striped table-actions">
                    ...
                    <tbody>
                          ...
                          <td class="td-device text-center">
                            <input type="hidden" name="resizeRuleList[0]['id']" value="3" />
                            <strong>3</strong>
                          ...
                          <td class="text-center">
                            <label class="switch">
                              ...
                              <span></span>
                                              ...
                                              <tr>
                          <td class="td-device text-center">
                            <input type="hidden" name="resizeRuleList[1]['id']" value="4" />
                            <strong>4</strong>
                                                          <div class="device all">
                                <i class="fa fa-circle" aria-hidden="true"></i>
                              </div><!-- end divece -->
                          ...
                          <td class="text-center">
                            <label class="switch">
                              <input type="checkbox" name="resizeRuleList[1]['delete']" value="1">
                              <span></span>
                            </label>
                          </td>
                        </tr>
            ...
            <div class="panel-body panel-body-table">
                  ...
                  <table id="thumbSectionList" class="table table-bordered table-striped table-actions">
                    ...
                    <tbody>
                                              <tr>
                          <td class="text-center">
                            <input type="hidden" name="thumbList[0]['id']" value="13" />
                            <strong>13</strong>
                          </td>
                          <td class="text-left">
                                                          Všetky sekcie
