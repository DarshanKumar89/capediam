<?php /*%%SmartyHeaderCode:182421543057dfac58cafdd0-94060977%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'edc2d980c4b1928feee673f2c632d3d53bce58aa' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/delivery/delivery_list.tpl',
      1 => 1474276415,
      2 => 'file',
    ),
    ...
    '0cfa8ef6388c7c5538ebe01c2aaaeaffe99ff491' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/delivery/delivery_list.tpl',
      1 => 1474276415,
      2 => 'extends',
  ...
  'nocache_hash' => '182421543057dfac58cafdd0-94060977',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_57dfac590f8b60_18614040',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57dfac590f8b60_18614040')) {function content_57dfac590f8b60_18614040($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="table-responsive">
              <table id="deliveryList" class="table table-bordered table-striped table-actions">
                ...
                <tbody>
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/1" class="btn btn-info" style="padding:7px;border-radius:100%;">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/2" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/3" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/4" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/5" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/6" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <label class="switch">
                          ...
                          <span></span>
                                      ...
                                      <tr>
                      <td class="text-center" style="font-weight:700;color:#2a2d34;">
                        <input type="hidden" name="deliveryList[6]['delivery-id']" value="7"/>
                        7
                      </td>
                      <td class="text-left">
                        <strong>DHL Express Italy</strong>
                      </td>
                      <td class="text-center">
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/7" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                        <label class="switch">
                          <input type="checkbox" name="deliveryList[6]['enable']" value="1" checked>
                          <span></span>
                        </label>
                      </td>
                      <td class="text-center">
                        <label class="switch">
                          <input type="checkbox" name="deliveryList[6]['remove']" value="1">
                          <span></span>
                        </label>
                      </td>
                    </tr>
                                      <tr>
                      <td class="text-center" style="font-weight:700;color:#2a2d34;">
                        <input type="hidden" name="deliveryList[7]['delivery-id']" value="8"/>
                        8
                      </td>
                      <td class="text-left">
                        <strong>Collezione personale - CarpeDM Merano</strong>
                      </td>
                      <td class="text-center">
                        <span class="flag-icon flag-icon-it" style="position: relative;top: -7px;width:23px;height:23px;"></span>
                        &nbsp;Italy
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/delivery/edit/8" class="btn btn-info" style="padding:7px;border-radius:100%;">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                        <label class="switch">
                          <input type="checkbox" name="deliveryList[7]['enable']" value="1" checked>
                          <span></span>
                        </label>
                      </td>
                      <td class="text-center">
                        <label class="switch">
                          <input type="checkbox" name="deliveryList[7]['remove']" value="1">
                          <span></span>
                        </label>
                      </td>
                    </tr>
