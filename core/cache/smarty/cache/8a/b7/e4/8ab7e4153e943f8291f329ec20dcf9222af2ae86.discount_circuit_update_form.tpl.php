...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '8ab7e4153e943f8291f329ec20dcf9222af2ae86' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/discount_circuit/discount_circuit_update_form.tpl',
      1 => 1469707244,
      2 => 'extends',
  ...
  'unifunc' => 'content_5879180e0cc8e2_13460328',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5879180e0cc8e2_13460328')) {function content_5879180e0cc8e2_13460328($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="panel panel-default tabs" style="margin: 5px 0;">                            
                  ...
                  <div class="panel-body tab-content">
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              <div id="r-k-v-c-7806-51" class="input-group">
                                                                  <span class="input-group-addon">
                                    <i class="fa fa-chrome"></i>
                                  </span>
                                  <input type="text" value="http://www.carpedmfashion.com/outlet" class="form-control" />
                                  <span class="input-group-btn">
                                    <a href="http://www.carpedmfashion.com/outlet" target="__blank" class="btn btn-primary">
                                      <i class="fa fa-eye"></i>
                                    </a>
                                  </span>
                                                              </div><!-- end input-group -->
                            </div><!-- end form-group -->
                            <div id="r-k-c-c-7806-51" class="row" style="display:none;">
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                <button type="button" id="r-k-c-b-c-7806-51" class="btn btn-default btn-block" style="margin-top: 22px;">
                                  <i class="fa fa-times"></i>&nbsp;
                                  CLOSE                                </button>
                              </div><!-- end col -->
                            </div><!-- end row -->
                                                          <div id="r-p-c-7806-51" class="row" style="display:none;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                  <button type="button" id="r-p-b-cl-7806-51" class="btn btn-default btn-block" style="margin-top: 22px;">
                                    <i class="fa fa-times"></i>&nbsp;
                                    CLOSE                                  </button>
                                </div><!-- end col -->
                              </div><!-- end row -->
                        ...
                        <div class="row">
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              <div id="r-k-v-c-8485-120" class="input-group">
                                                                  <span class="input-group-addon">
                                    <i class="fa fa-chrome"></i>
                                  </span>
                                  <input type="text" value="http://www.carpedmfashion.com/svendita" class="form-control" />
                                  <span class="input-group-btn">
                                    <a href="http://www.carpedmfashion.com/svendita" target="__blank" class="btn btn-primary">
                                      <i class="fa fa-eye"></i>
                                    </a>
                                  </span>
                                                              </div><!-- end input-group -->
                            </div><!-- end form-group -->
                            <div id="r-k-c-c-8485-120" class="row" style="display:none;">
                              <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                <div class="form-group">
                                  <label for="key">
                                    URL KEY
                              ...
                              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                <button type="button" id="r-k-c-b-c-8485-120" class="btn btn-default btn-block" style="margin-top: 22px;">
                                  <i class="fa fa-times"></i>&nbsp;
                                  CLOSE                                </button>
                              </div><!-- end col -->
                            </div><!-- end row -->
                                                          <div id="r-p-c-8485-120" class="row" style="display:none;">
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                  <div class="form-group">
                                    <label for="prefix">
                                      URL PREFIX
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                  <button type="button" id="r-p-b-cl-8485-120" class="btn btn-default btn-block" style="margin-top: 22px;">
                                    <i class="fa fa-times"></i>&nbsp;
                                    CLOSE                                  </button>
                                </div><!-- end col -->
                              </div><!-- end row -->
                              ...
                              <div class="panel-body panel-body-table">
                                    ...
                                    <table id="statusList" class="table table-bordered table-striped table-actions">
                                      ...
                                      <tbody>
                                            ...
                                            <td class="text-left">
                                              <strong>http://www.carpedmfashion.com/vendita</strong>
                                            </td>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group">
                              <div id="r-k-v-c-7682-189" class="input-group">
                                  ...
                                  <input type="text" value="http://www.carpedmfashion.com/vypredaj" class="form-control" />
                                  <span class="input-group-btn">
                                    <a href="http://www.carpedmfashion.com/vypredaj" target="__blank" class="btn btn-primary">
                                      <i class="fa fa-eye"></i>
                                    </a>
                                  </span>
                                                              </div><!-- end input-group -->
    ...
    <form action="cpanel/store-delete-article-list-from-discount-circuit" method="post" role="form">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="panel panel-default">
          <div class="panel-heading ui-draggable-handle">
            <h3 class="panel-title">
              <span class="btn btn-info" style="margin: 0 15px;">35</span>
              ZOZNAM PRODUKTOV
              &nbsp;<span class="badge">Zobrazených 1-10 z 35 záznamov</span>            </h3>
            <ul class="panel-controls">
              <li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:15px 10px;">
                  ...
                  <ul class="pagination pagination-sm pull-right"><li class="disabled"><a href="cpanel/store-update-discount-circuit-form/1/0/10"onclick="return false;"><i class="fa fa-angle-left"></i></a></li><li class="active"><a href="cpanel/store-update-discount-circuit-form/1/1/10">1</a></li><li class=""><a href="cpanel/store-update-discount-circuit-form/1/2/10">2</a></li><li class=""><a href="cpanel/store-update-discount-circuit-form/1/3/10">3</a></li><li class=""><a href="cpanel/store-update-discount-circuit-form/1/4/10">4</a></li><li class=""><a href="cpanel/store-update-discount-circuit-form/1/2/10"><i class="fa fa-angle-right"></i></a></li></ul>
                    ...
                    <div class="alert alert-danger" style="margin: 0 auto 15px auto;" role="alert">
                      <span class="error-number">18</span>
              ...
              <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                <table id="articleListDL" class="table table-bordered table-striped table-actions">
                  ...
                  <tbody>
                      ...
                      <td class="text-center">
                                                  <img src="/files/748b29651ebf6ad034c1307eff5c4c16.jpg" height="35" alt="Citizen1"/>
                                              </td>
                      <td class="text-center">
                        100021
                      </td>
                      ...
                      <td class="text-center">
                                                  <img src="/files/0f106fb1e24dbbfbfef01904e80a1bd6.jpg" height="35" alt="DSC00947"/>
                                              </td>
                      <td class="text-center">
                        100127
                      </td>
