<?php /*%%SmartyHeaderCode:1353643325588b2ff3068623-39658262%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47e3c4ce6e3ff48de39ccc507d9e5ac2f914f657' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/article_edit.tpl',
      1 => 1470843185,
      2 => 'file',
    ),
    ...
    'a2a2fa8e2906bb2bf19513eed76354110145fd36' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/article_edit.tpl',
      1 => 1470843185,
      2 => 'extends',
  ...
  'nocache_hash' => '1353643325588b2ff3068623-39658262',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_588b2ff4405437_12227652',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_588b2ff4405437_12227652')) {function content_588b2ff4405437_12227652($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
  <a href="cpanel/store/catalog/article/edit/345" title="GIRLY WAU PANTS">
    GIRLY WAU PANTS
  </a>
</li>
...
<form id="updateArticleForm" action="cpanel/store/catalog/article/update" method="post" role="form">
    <input type="hidden" name="article-id" value="345" />
                ...
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title" style="overflow: hidden;">
                        ...
                        <span style="display:block;font-size:1.4em;float:left;">
                            ...
                            <span style="font-weight:100;color:#000;">GIRLY WAU PANTS</span>
                        </span>
                    </h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6">
                            <div class="btn-group pull-right" role="group">
                                <a href="cpanel/store/catalog/article/edit/344"  class="btn btn-default" >
                                    <i class="fa fa-arrow-left"></i>
                                </a>
                                <a href="cpanel/store/catalog/article/edit/346"  class="btn btn-default" >
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="D&aacute;mske vel&uacute;rov&eacute; tepl&aacute;ky - GIRLY WAU PANTS"
                                                               placeholder="Site title"
                                                               class="form-control"/>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['description']" class="form-control" rows="5">D&aacute;mske ply&scaron;ov&eacute; dlh&eacute; tepl&aacute;ky.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['meta-description']"class="form-control" rows="5">D&aacute;mske ply&scaron;ov&eacute; dlh&eacute; tepl&aacute;ky.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12" style="margin-top:30px;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['html-content']" id="ckeditor_189" class="ckeditor" row="5"><p>Kvalitn&eacute;, žensk&eacute;, sexi ply&scaron;ov&eacute; tepl&aacute;ky. S&uacute; z hust&eacute;ho bavlnen&eacute;ho ply&scaron;u, ktor&yacute; sa v&yacute;borne perie. Maj&uacute; kr&aacute;snu,&nbsp;hust&uacute; v&yacute;&scaron;ivku z drobn&yacute;ch flitier. Dobre sedia na postave.</p>
</textarea>
                                                    </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                    ...
                    <div class="panel panel-default tabs" style="margin: 5px 0;">                            
                      ...
                      <div class="panel-body tab-content">
                            ...
                            <div class="row">
                              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                  <div id="r-k-v-c-8528-189" class="input-group">
                                                                          <span class="input-group-addon">
                                        <i class="fa fa-chrome"></i>
                                      </span>
                                      <input type="text" value="http://www.carpedmfashion.com/damske-oblecenie/damske-teplaky/damske-plysove-teplaky-girly-wau-pants" class="form-control" />
                                      <span class="input-group-btn">
                                        <a href="http://www.carpedmfashion.com/damske-oblecenie/damske-teplaky/damske-plysove-teplaky-girly-wau-pants" target="__blank" class="btn btn-primary">
                                          <i class="fa fa-eye"></i>
                                        </a>
                                      </span>
                                                                      </div><!-- end input-group -->
                                </div><!-- end form-group -->
                                <div id="r-k-c-c-8528-189" class="row" style="display:none;">
                                  <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                    <div class="form-group">
                                      <label for="key">
                                        URL KEY
                                  ...
                                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                    <button type="button" id="r-k-c-b-c-8528-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                      <i class="fa fa-times"></i>&nbsp;
                                      CLOSE                                    </button>
                                  </div><!-- end col -->
                                </div><!-- end row -->
                                                                  <div id="r-p-c-8528-189" class="row" style="display:none;">
                                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                      <div class="form-group">
                                        <label for="prefix">
                                          URL PREFIX
                                    ...
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                      <button type="button" id="r-p-b-cl-8528-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                        <i class="fa fa-times"></i>&nbsp;
                                        CLOSE                                      </button>
                                    </div><!-- end col -->
                                  </div><!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="reference" value="42d8199b78fe4e7e2635aef091b2ab36" minlength="10" maxlength="60" class="form-control" required="true" disabled="true">
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="sku" value="100339" minlength="3" maxlength="60" class="form-control" required>
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="article-name-internal" value="GIRLY WAU PANTS" minlength="3" maxlength="150" class="form-control" required>
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                        ...
                        <div class="col-lg-6">
                            <div class="row form-group">
                                ...
                                <div class="input-group col-lg-2 pull-left">
                                    <span class="article-image on">
                                                                                    <input type="hidden" name="image-id" value="4878"/>
                                            <img src="thumbnail/b76a3fb96f4bd91d69d96977044d65e0/auto/100" height="100" alt="DSC01435"/>
                                            <a href="cpanel/store/catalog/article/remove-article-image/345" class="btn btn-remove">
                                                <i class="fa fa-times"></i>
                                            </a>
                                ...
                                <div class="input-group col-lg-9 pull-right">
                                    <span class="input-group-btn">
                                        <a href="cpanel/store/catalog/article/choose-image/345/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                            <i class="glyphicon glyphicon-hdd"></i>
                                        </a>
                                    </span>
                                    <input type="text" 
                                           placeholder="DSC01435" 
                                           class="form-control">
                                    <span class="input-group-addon">
                            ...
                            <div class="form-group">
                                <label>
                                  ...
                                  <div style="overflow:hidden;">
                                      <a href="cpanel/gallery-edit/264" class="btn btn-success pull-left" style="display:inline-block;width: 49%;margin-right: 1%;">
                                        <i class="fa fa-picture-o"></i>&nbsp;ZOBRAZIŤ GALÉRIU
                                      </a>
                                      <a href="cpanel/store/catalog/article/delete-gallery/345" class="btn btn-danger pull-right" style="display:inline-block;width: 49%;margin-left: 1%;">
                            ...
                            <div class="row form-group" style="margin:0 -10px;">
                                <div class="col-lg-6">
                                    <label>
                                        New from Date                                    </label>
                                    <input type="text" name="new-from-date" value="2016-11-04" maxlength="12" class="form-control datepicker">
                                </div><!-- end col -->
                                <div class="col-lg-6">
                                    <label>
                                        New to Date                                    </label>
                                    <input type="text" name="new-to-date" value="2016-11-04" maxlength="12" class="form-control datepicker">
                                </div><!-- end col -->
                            </div><!-- end form-group -->
                        </div><!-- end col -->
                    </div><!-- end row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="qty" value="24" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-cog"></i>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="retail_price" value="23.33" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-money"></i>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="retail_tax_price" value="28" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-money"></i>
                                    </span>
                                </div>
                ...
                <table id="article-categories" class="table table-bordered table-striped table-actions">
                  ...
                  <tbody>
                            ...
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[0]['category-id']" value="1">
                              1
                            </td>
                            ...
                            <td class="text-center">
                              <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                  ...
                                                  <tr data-crn="2">
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[1]['category-id']" value="2">
                              2
                            </td>
                            <td class="text-center">
                                                              <span style="font-size:1.4em;color:red;">
                            ...
                            <td class="text-center">
                              <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                  ...
                                                  <tr data-crn="54">
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[2]['category-id']" value="54">
                              54
                            </td>
                            <td class="text-center">
                                                              <span style="font-size:1.4em;color:red;">
                            ...
                            <td class="text-center">
                              <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                  ...
                                                  <tr data-crn="67">
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[3]['category-id']" value="67">
                              67
                            </td>
                            <td class="text-center">
                                                              <span style="font-size:1.4em;color:red;">
                            ...
                            <td class="text-center">
                              <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                  ...
                                                  <tr data-crn="73">
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[4]['category-id']" value="73">
                              73
                            </td>
                            <td class="text-center">
                                                              <span style="font-size:1.4em;color:red;">
                    ...
                    <div class="table-responsive">
                        <table id="article-attribute-values" class="table table-bordered table-striped table-actions">
                            ...
                            <tbody>
                                                                                                            <tr data-arn="49">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[0]['attr-id']" value="3">
                                                <input type="hidden" name="attrValueList[0]['value-id']" value="49">
                                                1
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="114">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[1]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[1]['value-id']" value="114">
                                                2
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="115">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[2]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[2]['value-id']" value="115">
                                                3
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="116">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[3]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[3]['value-id']" value="116">
                                                4
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="117">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[4]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[4]['value-id']" value="117">
                                                5
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="129">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[5]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[5]['value-id']" value="129">
                                                6
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                ...
                                                <input type="hidden" name="attrValueList[6]['value-id']" value="150">
                                                7
                                            </td>
                                            <td class="text-left">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body panel-body-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="article-name" value="GIRLY WAU PANTS Kópia" class="form-control" required="">
                                    </div>
                                </div>
          ...
          <div class="panel-body panel-body-table">
                ...
                <table id="categorylist" class="table table-bordered table-striped table-actions datatable">
                  ...
                  <tbody>                                            
                        ...
                        <td class="text-center">
                          <button type="button" data-cat-id="80" class="btn btn-success push-x">
                        ...
                        <td class="text-left">
                          Detsk&aacute; kolekcia AMERICAN APACHE
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                          
                        </td>
                        <td class="text-center">
                          <button type="button" data-cat-id="79" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <td class="text-left">
                          D&aacute;mska kolekcia INITIALS
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                          
                        </td>
                        <td class="text-center">
                          <button type="button" data-cat-id="76" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <td class="text-left">
                          Mikiny: Basics d&aacute;mske mikiny a svetre
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                        ...
                        <td class="text-left">
                          AMERICAN APACHE detsk&eacute; tepl&aacute;ky
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                          
                        </td>
                        <td class="text-center">
                          <button type="button" data-cat-id="82" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <td class="text-center">
                          <button type="button" data-cat-id="77" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <td class="text-left">
                          P&aacute;nska kolekcia AMERICAN APACHE
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                          
                        </td>
                        <td class="text-center">
                          <button type="button" data-cat-id="78" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <td class="text-left">
                          AMERICAN APACHE p&aacute;nske tepl&aacute;ky
                        </td>
                        <td class="text-left" style="line-height: 15px;">
                          
                        </td>
                        <td class="text-center">
                          <button type="button" data-cat-id="81" class="btn btn-success push-x">
                            &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                          </button>
                        </td>
                      </tr>
                        ...
                        <div class="table-responsive" style="padding: 0px;">
                            <table id="attrValueList" class="table table-bordered table-striped table-actions datatable">
                                ...
                                <tbody>                                            
                                            ...
                                            <td class="text-center">
                                                <strong>kr&aacute;lovsk&aacute; modr&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>svetlozelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>koralov&aacute; červen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>tmavočerven&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>tmavohned&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>skarletov&aacute; červen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>tyrkysovo-zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>broskyňov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>akvamar&iacute;nov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>olivovozelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="173" data-atr="2" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>čiernosiv&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="174" data-atr="2" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>tmav&aacute; tyrkysov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="185" data-atr="2" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>p&uacute;drovo biela</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>mel&oacute;nov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>p&uacute;drovo-ružov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>levandulovo-ružov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>č&iacute;nska ruža</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>ferrari červen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>rub&iacute;novo-červen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>krvavočerven&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>červeno-hned&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>burgundsk&aacute; hned&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>tmavobordov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>ružovo-hned&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>svetlohru&scaron;kov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>hru&scaron;kov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>pist&aacute;ciov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>morsk&aacute; zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>tmav&yacute; mach</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>vojensk&aacute; zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>čiernohned&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>aquamar&iacute;nov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>limetkov&aacute; zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>olivov&aacute; zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>polnočn&aacute; zelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>čiernozelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>kralovsk&aacute; modr&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>atramentovomodr&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>svetlosiv&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>svetlo tyrkysov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="180" data-atr="3" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>orgov&aacute;nov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>cukr&iacute;kovoružov&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>hnedosiv&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="175" data-atr="4" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="176" data-atr="4" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="177" data-atr="4" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="178" data-atr="4" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>tmavozelen&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="184" data-atr="4" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-left">
                                                Akrylov&eacute; farby
                                            </td>
                                            <td class="text-left">
                                                                                                    <ol class="breadcrumb" style="background: transparent;margin: 0;padding: 2px;">
                                                                                                                    <li>Farby</li>
                                                                                                                    <li>Akrylov&eacute; farby</li>
                                                                                                             </ol>
                                                                                           </td>
                                            <td class="text-center">
                                                <strong>neonovo žlt&aacute;</strong>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <strong>elastick&yacute; bavlnen&yacute; kompozit - 75% bavlna, 23% polyester, 2% lycra</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="172" data-atr="14" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <strong>bavlnen&yacute; kompozit - 80% bavlna, 20% polyester</strong>
                                            </td>
                                            <td class="text-center">
                                                <button type="button" data-atv="179" data-atr="14" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="183" data-atr="14" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                                                           <tr data-arn="160">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">173</td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="160" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="161">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">174</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="161" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="162">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">175</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="162" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="163">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">176</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="163" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="164">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">177</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="164" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="165">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">178</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="165" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="166">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">179</td>
                                            <td class="text-left">
                                                Farba aplik&aacute;cie
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="166" data-atr="15" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                                           ...
                                                                           <tr data-arn="181">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">180</td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-left">
                                                                                                    <ol class="breadcrumb" style="background: transparent;margin: 0;padding: 2px;">
                                                                                                                    <li>Farby</li>
                                                                                                                    <li>Polyesterov&eacute; farby</li>
                                                                                                             </ol>
                                                                                           </td>
                                            <td class="text-center">
                                                <strong>čierna</strong>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="181" data-atr="16" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
                                                                           <tr data-arn="182">
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">181</td>
                                            <td class="text-left">
                                                Polyesterov&eacute; farby
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-atv="182" data-atr="16" class="btn btn-success push-y">
                                                    &nbsp;&nbsp;<span class="fa fa-plus-square"></span>
                                                </button>
                                            </td>
                                        </tr>
...
<script type="text/javascript">
  ...
  Search.init(true,0,0);

  Router.init();

  RelatedArticleList.init(345);

  AlternativeArticleList.init(345);
</script>
<script type="text/javascript">
$(function() {
