...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '93c991dc06057fdcbda44104da5d89bef8cfd189' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/attribute/attribute_update_value_form.tpl',
      1 => 1469707240,
      2 => 'extends',
  ...
  'unifunc' => 'content_5853ead31a2647_75596635',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5853ead31a2647_75596635')) {function content_5853ead31a2647_75596635($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<ul class="x-navigation" style="margin-bottom:98px;">
  ...
  <li class="active">
    <a href="cpanel/store-attribute-assigning-value-list/3" title="Priraďovanie hodnôt k atribútu">
...
<form id="updateAttributeValueForm" action="cpanel/store-update-attribute-value" method="post" role="form">
  <input type="hidden" name="attribute-id" value="3"/>
  <input type="hidden" name="value-id" value="80"/>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="form-group">
                  <label>Farba</label>
                  <div class="input-group color colorpicker" style="padding: 0px;" data-color="#0ac2c2" data-color-format="rgb">
                    <span class="input-group-addon">
                      <span class="fa fa-paint-brush"></span>
                    </span>
                    <input type="text" name="color" value="#0ac2c2" class="form-control"/>
                    <span class="input-group-addon">
                      <i style="background-color: #0ac2c2"></i>
                    </span>
                  </div>
                </div><!-- end form-group -->
              </div><!-- end col -->
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="values[51]['value']" value="turquoise"" class="form-control">
                      <span class="input-group-addon">
                          <i class="fa fa-file-text-o"></i>
                      </span>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="values[120]['value']" value="turchese"" class="form-control">
                      <span class="input-group-addon">
                          <i class="fa fa-file-text-o"></i>
                      </span>
                    </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="values[189]['value']" value="tyrkysov&aacute;"" class="form-control">
                      <span class="input-group-addon">
                          <i class="fa fa-file-text-o"></i>
                      </span>
                    </div>
