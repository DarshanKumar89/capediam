<?php /*%%SmartyHeaderCode:119847076358791f0f69aa50-69297920%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0f736c849ca6a968e343412e58715c6020cc94b2' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/navigation/nav_edit_item.tpl',
      1 => 1469707230,
      2 => 'extends',
    ),
  ),
  'nocache_hash' => '119847076358791f0f69aa50-69297920',
  'variables' => 
  array (
    'data' => 0,
  ...
  'unifunc' => 'content_58791f0f873389_68199866',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58791f0f873389_68199866')) {function content_58791f0f873389_68199866($_smarty_tpl) {?><div class="row">
    <div class="col-lg-12">
                            ...
                            <div class="form-group col-lg-12 col-sm-12 col-xs-12">
                                ...
                                <select id="category" name="category-id" class="form-control select" data-live-search="true" required="">
                                    <option value="0">Vyberte...</option>
                                                                            ...
                                                                            <option value="1" selected>D&aacute;mske oblečenie</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/1/51/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-bottom:15px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/1/120/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                    <i class="glyphicon glyphicon-hdd"></i>
                                                                </a>
                                                            </span>
                                                            <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-bottom:15px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/1/189/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                    <i class="glyphicon glyphicon-hdd"></i>
                                                                </a>
                                                            </span>
                                                            <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
