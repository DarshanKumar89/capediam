...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'ab1cecf51d54814e03fcfe083bf4a45f30fee7e0' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/slider/slider_edit.tpl',
      1 => 1469548190,
      2 => 'extends',
  ...
  'unifunc' => 'content_579786a3af5627_32286670',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579786a3af5627_32286670')) {function content_579786a3af5627_32286670($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <thead>
                  ...
                  <tbody>
                        ...
                        <td class="text-center tr-device">
                          <input type="hidden" name="images[0]['id']" value="3100" />
                          <a href="http://carpedmfashion.local/files/a9061a471b4bddc0014292c8e6e5bd76.jpg" onclick="return false;" rel="group" class="img-item" title="hl_banner3_1920x1080_">
                        ...
                        <td class="text-center">                                     
                          <select name="images[0]['rw-page-id']" class="form-control">
                            <option value="0">Vyberte...</option>
                                                          ...
                                                          <option value="7" >CARPE DM FASHION</option>
                        ...
                        <td class="text-center">
                          <label class="switch">
                            ...
                            <span></span>
                                          ...
                                          <tr>
                        <td class="text-center tr-device">
                          <input type="hidden" name="images[1]['id']" value="3106" />
                          <a href="http://carpedmfashion.local/files/356d35df769ef34e2ce9ed49d4883749.jpg" onclick="return false;" rel="group" class="img-item" title="hl_banner4_1920x1080_2">
                        ...
                        <td class="text-center">
                          <label class="switch">
                            ...
                            <span></span>
                                          ...
                                          <tr>
                        <td class="text-center tr-device">
                          <input type="hidden" name="images[2]['id']" value="3099" />
                          <a href="http://carpedmfashion.local/files/44d98dc8b8a7c2f793439c82de5e4562.jpg" onclick="return false;" rel="group" class="img-item" title="hl_banner1_1920x1080_">
                        ...
                        <td class="text-center">
                          <label class="switch">
                            <input type="checkbox" name="images[2]['publish']"  value="1">
                            <span></span>
                          </label>
                        </td>
                        <td class="text-center">
                          <label class="switch">
                            ...
                            <span></span>
                                          ...
                                          <tr>
                        <td class="text-center tr-device">
                          <input type="hidden" name="images[3]['id']" value="3105" />
                          <a href="http://carpedmfashion.local/files/c9908e04f9fe5dceec1fb897615d3481.jpg" onclick="return false;" rel="group" class="img-item" title="hl_banner2_1920x1080_2">
