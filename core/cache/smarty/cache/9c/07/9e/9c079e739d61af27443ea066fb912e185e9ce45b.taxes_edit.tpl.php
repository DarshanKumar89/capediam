...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '9c079e739d61af27443ea066fb912e185e9ce45b' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/taxes/taxes_edit.tpl',
      1 => 1469707246,
      2 => 'extends',
  ...
  'unifunc' => 'content_5847060db36648_45368047',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5847060db36648_45368047')) {function content_5847060db36648_45368047($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
    <a href="cpanel/store/localization/taxes/edit/1" title="DPH SK 20%">
        DPH SK 20%
    </a>
</li>
...
<div class="row">
    <div class="col-md-12">
        <form id="currency-form" action="cpanel/store/localization/taxes/update" method="post" role="form">
            <input type="hidden" name="tax-id" value="1" />
            <div class="panel panel-default">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title">DPH SK 20%</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tax-name" value="DPH SK 20%" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rate" value="20.000" class="form-control" required>
