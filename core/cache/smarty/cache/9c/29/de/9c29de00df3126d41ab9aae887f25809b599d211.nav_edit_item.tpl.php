<?php /*%%SmartyHeaderCode:16994105005798b83d18b365-89447010%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c29de00df3126d41ab9aae887f25809b599d211' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/navigation/nav_edit_item.tpl',
      1 => 1469528892,
      2 => 'extends',
    ),
  ),
  'nocache_hash' => '16994105005798b83d18b365-89447010',
  'variables' => 
  array (
    'data' => 0,
  ...
  'unifunc' => 'content_5798b83d222453_91926334',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5798b83d222453_91926334')) {function content_5798b83d222453_91926334($_smarty_tpl) {?><div class="row">
    <div class="col-lg-12">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="panel-body tab-content">
                                                                                <div class="tab-pane itemLang active" id="tab-en-GB">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/6/51/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-bottom:15px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/6/120/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                    <i class="glyphicon glyphicon-hdd"></i>
                                                                </a>
                                                            </span>
                                                            <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" style="margin-bottom:15px;">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group col-lg-9 pull-right">
                                                            <span class="input-group-btn">
                                                                <a href="cpanel/choose-nav-item-image/6/189/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                    <i class="glyphicon glyphicon-hdd"></i>
                                                                </a>
                                                            </span>
                                                            <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
