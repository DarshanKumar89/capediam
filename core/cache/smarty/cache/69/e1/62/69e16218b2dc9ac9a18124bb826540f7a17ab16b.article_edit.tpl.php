...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '69e16218b2dc9ac9a18124bb826540f7a17ab16b' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/article_edit.tpl',
      1 => 1469528904,
      2 => 'extends',
  ...
  'unifunc' => 'content_5798a02507dd30_94419344',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5798a02507dd30_94419344')) {function content_5798a02507dd30_94419344($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="cpanel/store/catalog/article/edit/1" title="WANT HOODIE">
        WANT HOODIE
    </a>
</li>
                ...
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title" style="overflow: hidden;">
                        ...
                        <span style="display:block;font-size:1.4em;float:left;">
                            ...
                            <span style="font-weight:100;color:#000;">WANT HOODIE</span>
                        </span>
                    </h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-6 col-xs-6">
                            <div class="btn-group pull-right" role="group">
                                <a href="#" onclick="return false;" class="btn btn-default" disabled>
                                    <i class="fa fa-arrow-left"></i>
                                </a>
                                <a href="cpanel/store/catalog/article/edit/2"  class="btn btn-default" >
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[51]['description']" class="form-control" rows="5">Women&acute;s, cotton hoodie with open pockets and large hood.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="womens,women&acute;s,cotton,hoodie,large,hood,comfortable,stylish,carpedm,fashion"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[51]['meta-description']"class="form-control" rows="5">Women&acute;s, cotton hoodie with open pockets and large hood.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12" style="margin-top:30px;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[51]['html-content']" id="ckeditor_51" class="ckeditor" row="5"><p>Women&acute;s, loose, comfortable, cotton hoodie with open pockets and large hood.</p>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="Felpa da donna - WANT HOODIE"
                                                               placeholder="Site title"
                                                               class="form-control"/>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[120]['description']" class="form-control" rows="5">Felpa da donna in cotone con ampie tasche e un grande cappuccio.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="donna,cotone,tuta,felpa,con cappuccio,con tasche,senza zip,prodotto di marca,carpedm,abbigliamento,in stile"
                                                               class="tagsinput form-control"/>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[120]['meta-description']"class="form-control" rows="5">Felpa da donna in cotone con ampie tasche e un grande cappuccio.</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12" style="margin-top:30px;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[120]['html-content']" id="ckeditor_120" class="ckeditor" row="5"><p>Donne, scioltezza e confort, felpa in cotone con tasche aperte e cappuccio.</p>
</textarea>
                                                    </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="D&aacute;mska mikina - WANT HOODIE"
                                                               placeholder="Site title"
                                                               class="form-control"/>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['description']" class="form-control" rows="5">D&aacute;mska mikina s veľk&yacute;mi vreckami</textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                               ...
                                                               value="damska,bavlnena,teplakova,mikina,s kapucnou,s vreckami,znackova,carpedm,oblecenie,stylova"
                                                               class="tagsinput form-control"/>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['meta-description']"class="form-control" rows="5">D&aacute;mska mikina s otvoren&yacute;mi vreckami a kapucňou. Pohodln&aacute; mikina, s otvoren&yacute;mi vreckami a preloženou kapucňou. Mikinu WANT HOODIE m&ocirc;že&scaron; nosiť s tepl&aacute;kmi WANT ako s&uacute;pravu. </textarea>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12" style="margin-top:30px;">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <textarea name="lang[189]['html-content']" id="ckeditor_189" class="ckeditor" row="5"><p>Pohodln&aacute; mikina,&nbsp;s otvoren&yacute;mi vreckami a preloženou kapucňou. Mikinu WANT HOODIE m&ocirc;že&scaron; k&uacute;piť aj ako vel&uacute;rov&uacute; mikinu <a href="damske-oblecenie/damske-mikiny/damska-mikina-want-hoodie-velour">WANT HOODIE VELOUR</a> a&nbsp;nosiť s tepl&aacute;kmi <a href="damske-oblecenie/damske-teplaky/want">WANT</a> ako s&uacute;pravu.&nbsp;</p>
</textarea>
                                                    </div>
                                            </div><!-- end col -->
                                        </div><!-- end row -->
                                ...
                                <div class="panel panel-default tabs">                            
                                    ...
                                    <div class="panel-body tab-content">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                                        <div class="form-group">
                                                            <div id="r-k-v-c-7731-189" class="input-group">
                                                                                                                                    <span class="input-group-addon">
                                                                        <i class="fa fa-chrome"></i>
                                                                    </span>
                                                                    <input type="text" value="http://carpedmfashion.local/damske-oblecenie/damske-mikiny/damska-mikina-want-hoodie" class="form-control" />
                                                                    <span class="input-group-btn">
                                                                        <a href="http://carpedmfashion.local/damske-oblecenie/damske-mikiny/damska-mikina-want-hoodie" target="__blank" class="btn btn-primary">
                                                                            <i class="fa fa-eye"></i>
                                                                        </a>
                                                                    </span>
                                                                                                                            </div>
                                                        </div><!-- end form-group -->
                                                        <div id="r-k-c-c-7731-189" class="row" style="display:none;">
                                                            <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                                                <div class="form-group">
                                                                    <label for="key">
                                                                        URL KEY
                                                            ...
                                                            <div class="col-lg-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                                                <button type="button" id="r-k-c-b-c-7731-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                                                    <i class="fa fa-times"></i>&nbsp;
                                                                    CLOSE                                                                </button>
                                                            </div><!-- end col -->
                                                        </div><!-- end row -->
                                                                                                                    <div id="r-p-c-7731-189" class="row" style="display:none;">
                                                                <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                                                    <div class="form-group">
                                                                        <label for="prefix">
                                                                            URL PREFIX
                                                                ...
                                                                <div class="col-lg-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                                                    <button type="button" id="r-p-b-cl-7731-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                                                        <i class="fa fa-times"></i>&nbsp;
                                                                        CLOSE                                                                    </button>
                                                                </div><!-- end col -->
                                                            </div><!-- end row -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="reference" value="9f30ee7ca56f95f9b21bfe503eadff8e" minlength="10" maxlength="60" class="form-control" required="true" disabled="true">
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="sku" value="100001" minlength="3" maxlength="60" class="form-control" required>
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" name="article-name-internal" value="WANT HOODIE" minlength="3" maxlength="150" class="form-control" required>
                                    <span class="input-group-addon">
                                        <i class="fa fa-info-circle"></i>
                                    </span>
                                </div><!-- end input-group -->
                        ...
                        <div class="col-lg-6">
                            <div class="row form-group">
                                ...
                                <div class="input-group col-lg-9 pull-right">
                                    <span class="input-group-btn">
                                        <a href="cpanel/store/catalog/article/choose-image/1/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                            ...
                            <div class="form-group">
                                <label>
                                  Gallery                                </label>                                                                              
                                                                  <input type="hidden" name="gallery-id" value="1"/>
                                  <div style="overflow:hidden;">
                                      <a href="cpanel/gallery-edit/1" class="btn btn-success pull-left" style="display:inline-block;width: 49%;margin-right: 1%;">
                                        <i class="fa fa-picture-o"></i>&nbsp;ZOBRAZIŤ GALÉRIU
                                      </a>
                                      <a href="cpanel/store/catalog/article/delete-gallery/1" class="btn btn-danger pull-right" style="display:inline-block;width: 49%;margin-left: 1%;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="qty" value="10" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-cog"></i>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="retail_price" value="48.33" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-money"></i>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" name="retail_tax_price" value="58" class="form-control"/>
                                    <span class="input-group-addon">
                                        <i class="fa fa-money"></i>
                                    </span>
                                </div>
                ...
                <table id="article-categories" class="table table-bordered table-striped table-actions">
                  ...
                  <tbody>
                            ...
                            <td class="text-center" style="font-weight:700;color:#660000;">
                              <input type="hidden" name="categories[0]['category-id']" value="27">
                              27
                            </td>
                        ...
                        <table id="article-attribute-values" class="table table-bordered table-striped table-actions">
                            ...
                            <tbody>
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="4">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[1]['attr-id']" value="2">
                                                <input type="hidden" name="attrValueList[1]['value-id']" value="4">
                                                2
                                            </td>
                                            <td class="text-left">
                                                Bavlnen&eacute; farby
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="15">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[2]['attr-id']" value="2">
                                                <input type="hidden" name="attrValueList[2]['value-id']" value="15">
                                                3
                                            </td>
                                            <td class="text-left">
                                                Bavlnen&eacute; farby
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="149">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[3]['attr-id']" value="14">
                                                <input type="hidden" name="attrValueList[3]['value-id']" value="149">
                                                4
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                ...
                                                <input type="hidden" name="attrValueList[4]['value-id']" value="114">
                                                5
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                ...
                                                <input type="hidden" name="attrValueList[5]['value-id']" value="115">
                                                6
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="116">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[6]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[6]['value-id']" value="116">
                                                7
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="117">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[7]['attr-id']" value="9">
                                                <input type="hidden" name="attrValueList[7]['value-id']" value="117">
                                                8
                                            </td>
                                            <td class="text-left">
                                                Žensk&eacute; veľkosti
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="$(this).closest('tr').remove();" class="btn btn-warning">
                                                    &nbsp;&nbsp;<span class="fa fa-minus"></span>
                                                                            ...
                                                                            <tr data-arn="167">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="attrValueList[8]['attr-id']" value="16">
                                                <input type="hidden" name="attrValueList[8]['value-id']" value="167">
                                                9
                                            </td>
                                            <td class="text-left">
                                                Dodacia doba
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body panel-body-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="article-name" value="WANT HOODIE Kópia" class="form-control" required="">
                                    </div>
                                </div>
...
<script type="text/javascript">
  ...
  RelatedArticleList.init(1);

  AlternativeArticleList.init(1);
</script>
<script type="text/javascript">
$(function() {
