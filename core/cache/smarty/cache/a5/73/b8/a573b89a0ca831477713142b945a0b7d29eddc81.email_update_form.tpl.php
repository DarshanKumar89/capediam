<?php /*%%SmartyHeaderCode:1989415270587ce696765965-21358247%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c037b6529734c06fefb8b655167fc1659cf74bb1' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/email/email_update_form.tpl',
      1 => 1474392129,
      2 => 'file',
    ),
    ...
    'a573b89a0ca831477713142b945a0b7d29eddc81' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/email/email_update_form.tpl',
      1 => 1474392129,
      2 => 'extends',
  ...
  'nocache_hash' => '1989415270587ce696765965-21358247',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_587ce696b24cf1_07848448',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_587ce696b24cf1_07848448')) {function content_587ce696b24cf1_07848448($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <form action="cpanel/update-email" method="post" role="form">
      <input type="hidden" name="email-id" value="2" />
      <div class="panel panel-colorful fix-panel">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" 
                    name="email-name"
                    value="Objedn&aacute;vka spracovan&aacute;" 
                    class="form-control"
                    required 
                  />
                </div><!-- end input-group -->
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" 
                                ...
                                value="estore@carpedmfashion.com" 
                                class="form-control"
                                required 
                              />
                            </div><!-- end input-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text"
                                ...
                                value="CarpeDM Fashion (www.carpedmfashion.com)"
                                class="form-control"
                              />
                            </div><!-- end input-group -->
                          </div><!-- end form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[51]['signature']" class="form-control" rows="9">CARPE DM s.r.o. 
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[51]['html-content']" id="ckeditor_51" class="ckeditor" row="90"><p dir="ltr"><span style="font-size:14px;"><small><big><span style="font-family: arial, helvetica, sans-serif;">V&aacute;žen&aacute; z&aacute;kazn&iacute;čka / v&aacute;žen&yacute; z&aacute;kazn&iacute;k<em style="font-family: 'comic sans ms', cursive;">,</em></span></big></small></span></p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group bcc-field">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" 
                                name="data[120]['bcc']" 
                                value="kleinova@carpedmfashion.com" 
                                class="form-control tagsinput"
                              />
                            </div><!-- end input-group -->
                          </div><!-- end form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[120]['signature']" class="form-control" rows="9">Stanislava Klein - CARPE DM
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[120]['html-content']" id="ckeditor_120" class="ckeditor" row="90"><p dir="ltr" style="line-height: 20.8px;"><span style="font-size: 14px;"><small><big><span style="font-family: arial, helvetica, sans-serif;"><em comic="" ms="" sans="" style="font-family:;">Gentile cliente</em></span></big></small></span></p>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group bcc-field">
                            ...
                            <div class="input-group">
                              ...
                              <input type="text" 
                                name="data[189]['bcc']" 
                                value="dzurnikova@carpedmfashion.com" 
                                class="form-control tagsinput"
                              />
                            </div><!-- end input-group -->
                          </div><!-- end form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[189]['signature']" class="form-control" rows="9">CARPE DM s.r.o. 
zap&iacute;san&aacute; v obchodnom registri Okresn&eacute;ho s&uacute;du Pre&scaron;ov, oddiel: Sro, vložka č&iacute;slo: 24408/P 
IČO: 46 171 096
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <textarea name="data[189]['html-content']" id="ckeditor_189" class="ckeditor" row="90"><p dir="ltr"><span style="font-size:14px;"><small><big><span style="font-family: arial, helvetica, sans-serif;">V&aacute;žen&aacute; z&aacute;kazn&iacute;čka / v&aacute;žen&yacute; z&aacute;kazn&iacute;k<em style="font-family: 'comic sans ms', cursive;">,</em></span></big></small></span></p>
