...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '7c946d822eaa8cc0703c60976df44f9c27d2ffea' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/email/email_list.tpl',
      1 => 1460547465,
      2 => 'extends',
  ...
  'unifunc' => 'content_573a1e76c57a01_03350596',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573a1e76c57a01_03350596')) {function content_573a1e76c57a01_03350596($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">EMAIL LIST&nbsp;<span class="badge">3</span></h3>
                            ...
                            <table id="statusList" class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                           ...
                                           <td class="text-center">
                                            ...
                                            <td class="text-left">
                                                                                                    Carpe DM Fashion (www.carpedmfashion.com)
                                                                                            </td>
                                            <td class="text-left">
                                           ...
                                           <td class="text-center">
                                                <span class="circle-indicator center black">
                                                    <i class="fa fa-bullseye"></i>
                                                </span>
                                            </td>
                                            <td class="text-left">hjjhgf</td>
                                            <td class="text-left">
