<?php /*%%SmartyHeaderCode:149139560058764ae60c0811-84799697%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86aa980ac258eb03fe29f29b2e2ebfeebf96de1b' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/attribute/attribute_update_form.tpl',
      1 => 1469707240,
      2 => 'file',
    ),
    ...
    'e6a7bd779bf5c767094bc90115f5198bdf9368c7' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/attribute/attribute_update_form.tpl',
      1 => 1469707240,
      2 => 'extends',
  ...
  'nocache_hash' => '149139560058764ae60c0811-84799697',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_58764ae6f10718_50618439',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58764ae6f10718_50618439')) {function content_58764ae6f10718_50618439($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
    <a href="cpanel/store-update-attribute-form/14"
       title="                Materi&aacute;l - zloženie
            ">
...
<form id="createAttributeForm" action="cpanel/store-update-attribute" method="post" role="form">
    <input type="hidden" name="attribute-id" value="14" />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="input-group col-lg-9 col-md-9 col-sm-6 col-xs-6 pull-right">
                                                        <span class="input-group-btn">
                                                            <a href="cpanel/store-choose-attribute-image/14/51/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[51]['attribute-name-internal']" value="Material - composition" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[51]['attribute-name-public']" value="Material - composition" class="form-control" required>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[51]['title']" value="Material - composition" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="input-group col-lg-9 col-md-9 col-sm-6 col-xs-6 pull-right">
                                                        <span class="input-group-btn">
                                                            <a href="cpanel/store-choose-attribute-image/14/120/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                <i class="glyphicon glyphicon-hdd"></i>
                                                            </a>
                                                        </span>
                                                        <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[120]['attribute-name-internal']" value="Materiale - composizione" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[120]['attribute-name-public']" value="Materiale - composizione" class="form-control" required>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[120]['title']" value="Materiale - composizione" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="input-group col-lg-9 col-md-9 col-sm-6 col-xs-6 pull-right">
                                                        <span class="input-group-btn">
                                                            <a href="cpanel/store-choose-attribute-image/14/189/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                                                <i class="glyphicon glyphicon-hdd"></i>
                                                            </a>
                                                        </span>
                                                        <input type="text" class="form-control" placeholder="Načítať obrázok z drive">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[189]['attribute-name-internal']" value="Materi&aacute;l - zloženie" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[189]['attribute-name-public']" value="Materi&aacute;l - zloženie" class="form-control" required>
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="lang[189]['title']" value="Materi&aacute;l - zloženie" class="form-control">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-file-text-o"></i>
                                                        </span>
                                                    </div>
