...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'c6970127b3fb1b90c76975f2f4fba964e3e41400' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/statuses/status_list.tpl',
      1 => 1469707249,
      2 => 'extends',
  ...
  'unifunc' => 'content_58464150dfc4e5_70596461',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58464150dfc4e5_70596461')) {function content_58464150dfc4e5_70596461($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                            <table id="statusList" class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="renderEdit(1);" class="btn btn-info" style="padding:7px;border-radius:100%;" title="">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="renderEdit(2);" class="btn btn-info" style="padding:7px;border-radius:100%;" title="">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </button>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="renderEdit(3);" class="btn btn-info" style="padding:7px;border-radius:100%;" title="">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </button>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="renderEdit(4);" class="btn btn-info" style="padding:7px;border-radius:100%;" title="">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </button>
                                            </td>
                                            <td class="text-center">
                                            ...
                                            <div class="panel-body tab-content">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="statuses-lang[51]['status-name']" value="" class="form-control" minlength="3" maxlength="150" required="">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-file-text-o"></i>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="statuses-lang[120]['status-name']" value="" class="form-control" minlength="3" maxlength="150" required="">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-file-text-o"></i>
                                                                </span>
                                                            </div>
