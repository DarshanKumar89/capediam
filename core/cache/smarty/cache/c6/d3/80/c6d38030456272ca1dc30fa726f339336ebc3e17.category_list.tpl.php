...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'c6d38030456272ca1dc30fa726f339336ebc3e17' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/catalog/category/category_list.tpl',
      1 => 1460547461,
      2 => 'extends',
  ...
  'unifunc' => 'content_5730a22f8bb838_22762849',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5730a22f8bb838_22762849')) {function content_5730a22f8bb838_22762849($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="widget widget-danger widget-padding-sm">                            
                            <div class="widget-item-left">
                                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="40%" data-readOnly="true" data-thickness=".2"/>
                            </div>
                            <div class="widget-data">
                            ...
                            <table id="categoryList" class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/1"  style="background-color:#1458a9">
                                                                Ženy
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/73"  style="background-color:#69944d">
                                                                Basics d&aacute;mske oblečenie
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/2" class="active" style="background-color:#121c9e">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/25"  style="background-color:#07d149">
                                                                D&aacute;mske kolekcie
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/3" class="active" style="background-color:#c65e5a">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/25"  style="background-color:#38e600">
                                                                D&aacute;mske kolekcie
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/3"  style="background-color:#d3cc66">
                                                                D&aacute;mska kolekcia BLACKGREY
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/4" class="active" style="background-color:#884caf">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/25"  style="background-color:#816276">
                                                                D&aacute;mske kolekcie
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/5" class="active" style="background-color:#f76df4">
                                           ...
                                           <td class="text-center">
                                               <label class="switch">
                                                    ...
                                                    <span></span>
                                                                          ...
                                                                          <tr style="border-bottom:2px solid #fea223;border-left: 2px solid #fea223;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[5]['category-id']" value='55'/>
                                               55
                                           </td>
                                           <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/72"  style="background-color:#a1624b">
                                                                Novinky
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/52"  style="background-color:#423a37">
                                                                P&aacute;nske novinky
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/55" class="active" style="background-color:#43317b">
                                           ...
                                           <td class="text-center">
                                               <label class="switch">
                                                    ...
                                                    <span></span>
                                                                          ...
                                                                          <tr style="border-bottom:2px solid #95b75d;border-left: 2px solid #95b75d;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[6]['category-id']" value='7'/>
                                               7
                                           </td>
                                           <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                           ...
                                           <td class="text-center">
                                               <label class="switch">
                                                    ...
                                                    <span></span>
                                                                          ...
                                                                          <tr style="border-bottom:2px solid #fea223;border-left: 2px solid #fea223;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[7]['category-id']" value='8'/>
                                               8
                                           </td>
                                           <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/7"  style="background-color:#de5f5f">
                                                                Muži
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/75"  style="background-color:#38fb1c">
                                                                Basics p&aacute;nske oblečenie
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/8" class="active" style="background-color:#bc0d32">
                                           ...
                                           <td class="text-center">
                                               <label class="switch">
                                                    ...
                                                    <span></span>
                                                                          ...
                                                                          <tr style="border-bottom:2px solid #fea223;border-left: 2px solid #fea223;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[8]['category-id']" value='54'/>
                                               54
                                           </td>
                                           <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
                                           ...
                                           <td class="text-left">
                                                                                            <ul id="tree-tags">
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/72"  style="background-color:#1140d5">
                                                                Novinky
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/12"  style="background-color:#b51c53">
                                                                D&aacute;mske novinky
                                                            </a>
                                                        </li>
                                                                                                            <li>
                                                            <a href="cpanel/store-update-category-form/54" class="active" style="background-color:#ba7ccc">
                                           ...
                                           <td class="text-center">
                                               <label class="switch">
                                                    ...
                                                    <span></span>
                                                                          ...
                                                                          <tr style="border-bottom:2px solid #95b75d;border-left: 2px solid #95b75d;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[9]['category-id']" value='10'/>
                                               10
                                           </td>
                                           <td class="text-center">
                                                                                                    <span style="font-size:1.4em;color:red;">
