...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    'b6546ac87634f514521648370c6a0759f437bbd9' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/currencies/currencies_list.tpl',
      1 => 1469707245,
      2 => 'extends',
  ...
  'unifunc' => 'content_58470624e12844_61538492',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58470624e12844_61538492')) {function content_58470624e12844_61538492($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
    <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">CURRENCIES&nbsp;<span class="badge">1</span></h3>
                        <ul class="panel-controls">
                            <li>
                                <a href="#" onclick="return false;" class="panel-collapse">
                                    <span class="fa fa-angle-down"></span>
                            ...
                            <table class="table table-bordered table-striped table-actions">
                                ...
                                <tbody>                                            
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="currencies[0]['currency-id']" value="1"/>
                                                1
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/store/localization/currencies/edit/1" class="btn btn-block btn-info" title="Euro">
                                                    <span class="fa fa-pencil"></span>
                                                    &nbsp;Editovať                                                </a>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="currencies[0]['enable']" checked="" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="currencies[0]['remove']" value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                        </tr>
