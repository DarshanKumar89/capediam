...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '6bc5a0c38f85d0d9630c6b2227d612412d40856b' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_edit.tpl',
      1 => 1469707231,
      2 => 'extends',
  ...
  'unifunc' => 'content_58791b40f09d03_55180081',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58791b40f09d03_55180081')) {function content_58791b40f09d03_55180081($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
<h4 class="text-center">Men (numbers&nbsp;in&nbsp;cm)</h4>
...
<table class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			...
			<th class="text-center">Height - appx.</th>
...
<h4 class="text-center">Women (numbers in&nbsp;cm)</h4>
...
<table class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			<th class="text-center">Size</th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Height - appx.</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Chest</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Waist</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Hips</span></th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<h4 class="text-center">Kids (numbers in&nbsp;cm)</h4>

<div class="table-responsive">
<table class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Size</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Height - appx.</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Chest</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Waist</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Hips</span></th>
                    ...
                    <div class="col-lg-12" style="margin-top:30px;">
                      ...
                      <div class="input-group">
                        ...
                        <textarea name="lang[120]['html-content']" id="ckeditor_120" class="ckeditor" row="5">
                          <section class="row" id="size-chart">
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
<h4 class="text-center">Uomini (numeri&nbsp;in&nbsp;cm)</h4>
...
<table class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			...
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Altezza - appr.</span></th>
			<th class="text-center">Petto</th>
			<th class="text-center">Striscia</th>
			<th class="text-center">Fianchi</th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<h4 class="text-center">Donne (numeri&nbsp;in&nbsp;cm)</h4>

<div class="table-responsive">
<table class="table table-bordered table-striped table-hover">
	<thead>
		<tr>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Dimensione</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Altezza - appr.</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Petto</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Striscia</span></th>
			<th class="text-center"><span style="font-weight: bold; line-height: 20.8px; text-align: center;">Fianchi</span></th>
		</tr>
	</thead>
	<tbody>
		<tr>
...
<h4 class="text-center">Bambini (numeri&nbsp;in&nbsp;cm)</h4>
                  ...
                  <div class="panel panel-default tabs" style="margin: 5px 0;">                            
                    ...
                    <div class="panel-body tab-content">
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <div id="r-k-v-c-7883-51" class="input-group">
                                                                      <span class="input-group-addon">
                                      <i class="fa fa-chrome"></i>
                                    </span>
                                    <input type="text" value="http://www.carpedmfashion.com/size-chart" class="form-control" />
                                    <span class="input-group-btn">
                                      <a href="http://www.carpedmfashion.com/size-chart" target="__blank" class="btn btn-primary">
                                        <i class="fa fa-eye"></i>
                                      </a>
                                    </span>
                                                                  </div><!-- end input-group -->
                              </div><!-- end form-group -->
                              <div id="r-k-c-c-7883-51" class="row" style="display:none;">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                  <button type="button" id="r-k-c-b-c-7883-51" class="btn btn-default btn-block" style="margin-top: 22px;">
                                    <i class="fa fa-times"></i>&nbsp;
                                    CLOSE                                  </button>
                                </div><!-- end col -->
                              </div><!-- end row -->
                                                              <div id="r-p-c-7883-51" class="row" style="display:none;">
                                  ...
                                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                    <button type="button" id="r-p-b-cl-7883-51" class="btn btn-default btn-block" style="margin-top: 22px;">
                                      <i class="fa fa-times"></i>&nbsp;
                                      CLOSE                                    </button>
                                  </div><!-- end col -->
                                </div><!-- end row -->
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <div id="r-k-v-c-7882-120" class="input-group">
                                                                      <span class="input-group-addon">
                                      <i class="fa fa-chrome"></i>
                                    </span>
                                    <input type="text" value="http://www.carpedmfashion.com/tabella-di-scala" class="form-control" />
                                    <span class="input-group-btn">
                                      <a href="http://www.carpedmfashion.com/tabella-di-scala" target="__blank" class="btn btn-primary">
                                        <i class="fa fa-eye"></i>
                                      </a>
                                    </span>
                                                                  </div><!-- end input-group -->
                              </div><!-- end form-group -->
                              <div id="r-k-c-c-7882-120" class="row" style="display:none;">
                                <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                  <div class="form-group">
                                    <label for="key">
                                      URL KEY
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                  <button type="button" id="r-k-c-b-c-7882-120" class="btn btn-default btn-block" style="margin-top: 22px;">
                                    <i class="fa fa-times"></i>&nbsp;
                                    CLOSE                                  </button>
                                </div><!-- end col -->
                              </div><!-- end row -->
                                                              <div id="r-p-c-7882-120" class="row" style="display:none;">
                                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                    <div class="form-group">
                                      <label for="prefix">
                                        URL PREFIX
                                  ...
                                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                    <button type="button" id="r-p-b-cl-7882-120" class="btn btn-default btn-block" style="margin-top: 22px;">
                                      <i class="fa fa-times"></i>&nbsp;
                                      CLOSE                                    </button>
                                  </div><!-- end col -->
                                </div><!-- end row -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <div id="r-k-v-c-7678-189" class="input-group">
                                    ...
                                    <input type="text" value="http://www.carpedmfashion.com/tabulka-velkosti" class="form-control" />
                                    <span class="input-group-btn">
                                      <a href="http://www.carpedmfashion.com/tabulka-velkosti" target="__blank" class="btn btn-primary">
                                        <i class="fa fa-eye"></i>
                                      </a>
                                    </span>
                                                                  </div><!-- end input-group -->
