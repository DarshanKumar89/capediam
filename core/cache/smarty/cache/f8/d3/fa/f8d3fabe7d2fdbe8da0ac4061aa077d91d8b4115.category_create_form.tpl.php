<?php /*%%SmartyHeaderCode:162076123857ea160540f7b4-26076703%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9532239cb0f081d0bee5cef25a529bbc7e1226af' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/category/category_create_form.tpl',
      1 => 1469707241,
      2 => 'file',
    ),
    ...
    'f8d3fabe7d2fdbe8da0ac4061aa077d91d8b4115' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/category/category_create_form.tpl',
      1 => 1469707241,
      2 => 'extends',
  ...
  'nocache_hash' => '162076123857ea160540f7b4-26076703',
  'variables' => 
  array (
    'baseUrl' => 0,
    'defaultLanguage' => 0,
  ...
  'unifunc' => 'content_57ea1605a37069_83432452',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ea1605a37069_83432452')) {function content_57ea1605a37069_83432452($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="cpanel/store-create-category" title="Nová kategória">
        Nová kategória    </a>
</li>
...
<form id="createCategoryForm" action="cpanel/store-create-category" method="post" role="form">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="lang[189]['category-name']" value="" class="form-control" required>
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-file-text-o"></i>
                                                            </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="lang[189]['site-title']" value="" class="form-control">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-file-text-o"></i>
                                                            </span>
                                                        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#categories-tree").tree("collapseAll");
            var selected_categories = new Array("2");
            ...
            function()
            {
                if ($.inArray($(this).val(), selected_categories) != -1)
                {
                    ...
                    $(this).parents('ul.tree').each(function(){
                        $(this).show();
                        $(this).prev().find('.fa-folder-o').removeClass('fa-folder-o').addClass('fa-folder-open-o');	
                    });
                }
            }
        );
