...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  array (
    ...
    '73fa1c75d90214b2556c9e3a6ec6a3cc9d74ad31' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_list_edit_form.tpl',
      1 => 1473167056,
      2 => 'extends',
  ...
  'unifunc' => 'content_5837f3075bffc9_69553755',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5837f3075bffc9_69553755')) {function content_5837f3075bffc9_69553755($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
  <a href="cpanel/page-list-edit/2" title="OSOBNOSTI">
    OSOBNOSTI
  </a>
</li>
...
<form id="editPageListForm"  action="cpanel/update-page-list" method="post" role="form">
  <input type="hidden" name="page-list-id" value="2" />
              ...
              <div class="panel-body tab-content">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="input-group col-lg-10 col-sm-10 col-xs-10 pull-right">
                          <span class="input-group-btn">
                            <a href="cpanel/choose-page-image/2//51/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="input-group col-lg-10 col-sm-10 col-xs-10 pull-right">
                          <span class="input-group-btn">
                            <a href="cpanel/choose-page-image/2//120/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                              <i class="glyphicon glyphicon-hdd"></i>
                            </a>
                          </span>
                          <input type="text"
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                      ...
                      <div class="row form-group">
                        ...
                        <div class="input-group col-lg-10 col-sm-10 col-xs-10 pull-right">
                          <span class="input-group-btn">
                            <a href="cpanel/choose-page-image/2//189/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                              <i class="glyphicon glyphicon-hdd"></i>
                            </a>
                          </span>
                          <input type="text"
                  ...
                  <div class="panel panel-default tabs" style="margin: 5px 0;">                            
                    ...
                    <div class="panel-body tab-content">
                          ...
                          <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <div class="form-group">
                                <div id="r-k-v-c-7686-189" class="input-group">
                                                                      <span class="input-group-addon">
                                      <i class="fa fa-chrome"></i>
                                    </span>
                                    <input type="text" value="http://www.carpedmfashion.com/magazin/osobnosti" class="form-control" />
                                    <span class="input-group-btn">
                                      <a href="http://www.carpedmfashion.com/magazin/osobnosti" target="__blank" class="btn btn-primary">
                                        <i class="fa fa-eye"></i>
                                      </a>
                                    </span>
                                                                  </div><!-- end input-group -->
                              </div><!-- end form-group -->
                              <div id="r-k-c-c-7686-189" class="row" style="display:none;">
                                <div class="col-lg-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                  <div class="form-group">
                                    <label for="key">
                                      URL KEY
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                  <button type="button" id="r-k-c-b-c-7686-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                    <i class="fa fa-times"></i>&nbsp;
                                    CLOSE                                  </button>
                                </div><!-- end col -->
                              </div><!-- end row -->
                                                              <div id="r-p-c-7686-189" class="row" style="display:none;">
                                  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10" style="padding-left: 0px;">
                                    <div class="form-group">
                                      <label for="prefix">
                                        URL PREFIX
                                  ...
                                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2" style="padding-right: 0px;">
                                    <button type="button" id="r-p-b-cl-7686-189" class="btn btn-default btn-block" style="margin-top: 22px;">
                                      <i class="fa fa-times"></i>&nbsp;
                                      CLOSE                                    </button>
                                  </div><!-- end col -->
                                </div><!-- end row -->
                  ...
                  <div class="row">
                      <div class="col-lg-6 col-sm-12 col-xs-12">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="page-list-name" value="OSOBNOSTI" class="form-control">
                          </div><!-- end form -->
                          <div class="form-group">
                              <label>
                                  CSS ID                              </label>
                      ...
                      <div class="col-lg-6 col-sm-12 col-xs-12">
                          ...
                          <div class="row form-group">
                              ...
                              <div class="input-group col-lg-10 col-sm-10 col-xs-10 pull-right">
                                  <span class="input-group-btn">
                                      <a href="cpanel/choose-page-list-image/1/2/0/7259b712f116a7fe6310cdc765c836af" class="btn btn-default">
                                          <i class="glyphicon glyphicon-hdd"></i>
                                      </a>
                                  </span>
          ...
          <div class="panel panel-info">
              <div class="panel-heading ui-draggable-handle">
                  <h3 class="panel-title">
                      ...
                      Stránky&nbsp;
                                                <span class="btn btn-info" style="margin: 0 15px;">3</span>
                          <span class="btn btn-warning" style="margin: 0 15px;">0</span>
                          <span class="badge">Zobrazených 1-50 z 3 záznamov</span>
                          <span class="badge">0&nbsp;Zotriedených záznamov</span>
                          <span class="badge">3&nbsp;Nezotriedených záznamov</span>
                                        </h3>
                  <ul class="panel-controls">
                      <li>
              ...
              <div class="panel-body panel-body-table">
                          ...
                          <div class="col-lg-12" style="padding:15px 10px;">
                              <div class="form-group pull-left" style="width:280px;margin-right:5px;">
                                  <select class="form-control select" onchange="location = 'cpanel/page-list-edit/2/1/50/'+this.options[this.selectedIndex].value;">
                              ...
                              <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                  <select class="form-control select" onchange="location = 'cpanel/page-list-edit/2/1/'+this.options[this.selectedIndex].value+'/0';">
                              ...
                              <div class="form-group pull-left" style="width:400px;margin-right:5px;">
                                  <div class="input-group">
                                      ...
                                      <span class="input-group-btn">
                                          <button type="button" onclick="location = 'cpanel/page-list-edit/2/1/10?q='+document.getElementById('search').value;" class="btn btn-default">
                                              <i class="fa fa-search"></i>
                                          </button>
                                      </span>
                                  </div>
                              </div>
                              <ul class="pagination pagination-sm pull-right"><li class="disabled"><a href="cpanel/page-list-edit/2/0/50/0"onclick="return false;"><i class="fa fa-angle-left"></i></a></li><li class="active"><a href="cpanel/page-list-edit/2/1/50/0">1</a></li><li class="disabled"><a href="cpanel/page-list-edit/2/2/50/0"onclick="return false;"><i class="fa fa-angle-right"></i></a></li></ul>
                          </div>
                      </div><!-- end row -->
                          ...
                          <table id="pageList" class="table table-bordered table-striped table-actions">
                              ...
                              <tbody>
                                          ...
                                          <td class="text-center">
                                            <input type="hidden" name="pageList[0]['page-id']" value="8" />
                                            <input type="checkbox" name="pageList[0]['on']" value="8">
                                          </td>
                                          <td class="text-left">
                                          ...
                                          <td class="text-center">
                                            ...
                                            <input type="checkbox" name="pageList[1]['on']" value="2">
                                          </td>
                                          <td class="text-left">
                                          ...
                                          <td class="text-center">
                                            <a href="cpanel/page-edit/2" target="__blank" class="btn btn-info" style="padding:7px;border-radius:100%;" title="MAJK SPIRIT - BIELY PRINC">
                                              <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                            </a>
                                          </td>
                                          <td class="text-center">
                                          ...
                                          <td class="text-center">
                                              <label class="switch">
                                                  ...
                                                  <span></span>
                                                                        ...
                                                                        <tr>
                                          <td class="text-center">
                                            <input type="hidden" name="pageList[2]['page-id']" value="6" />
                                            <input type="checkbox" name="pageList[2]['on']" value="6">
                                          </td>
                                          <td class="text-left">
