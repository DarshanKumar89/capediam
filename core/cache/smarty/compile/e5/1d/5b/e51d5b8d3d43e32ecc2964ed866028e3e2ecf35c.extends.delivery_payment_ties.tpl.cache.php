<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-03 15:38:35
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/ties/delivery_payment_ties.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5842d8ec4933b8_86403099',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5842d8ec4933b8_86403099')) {function content_5842d8ec4933b8_86403099($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="cpanel/store/delivery-payment/ties" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value)) {
echo $_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value;
} else { ?>DELIVERY-PAYMENT TIES<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value)) {
echo $_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value;
} else { ?>DELIVERY-PAYMENT TIES<?php }?>
    </a>
</li>
    ...
    <div class="page-title">                    
        <h2>
            <i class="fa fa-exchange"></i>&nbsp;
            <?php if (!empty($_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_delivery_payment_ties']->value, 'UTF-8');
} else { ?>DELIVERY-PAYMENT TIES<?php }?>&nbsp;
...
echo $_smarty_tpl->tpl_vars['global_alert_warning']->value;
                    ...
                    <?php if (!empty($_smarty_tpl->tpl_vars['store_delivery_form_empty_delivery_list']->value)) {
echo $_smarty_tpl->tpl_vars['store_delivery_form_empty_delivery_list']->value;
} else { ?>You have no delivery methods.You must first create a new delivery method.<?php }?>
                </div>
            </div><!-- end col -->
        </div><!-- end row -->
    <?php } else { ?>
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                 <div class="form-group">
                    <label><?php if (!empty($_smarty_tpl->tpl_vars['store_section_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_']->value, 'UTF-8');
} else { ?>DELIVERY LIST<?php }?></label>                                        
...
?>
                            <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_delivery;?>
" <?php if ($_smarty_tpl->tpl_vars['deliveryId']->value==$_smarty_tpl->tpl_vars['item']->value->id_delivery) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value->delivery_name;?>
</option>
                        <?php } ?>
                    </select>
                </div>
        ...
        <div class="row" style="margin-top:25px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <?php if (!empty($_smarty_tpl->tpl_vars['deliveryId']->value)) {?>
                    <form action="cpanel/store/delivery-payment/ties/save" method="post" role="form">
                        <input type="hidden" name="delivery-id" value="<?php echo $_smarty_tpl->tpl_vars['deliveryId']->value;?>
"/>
...
} else { ?>DELIVERY - PAYMENT LIST<?php }?>
                                </h3>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_gallery_table_header_remove']->value, 'UTF-8');
                                        ...
                                        <tbody>
                                            <?php if (!is_null($_smarty_tpl->tpl_vars['deliveryPaymentTiesList']->value)) {?>
                                                <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['deliveryPaymentTiesList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                                                    <tr data-an="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_payment;?>
">
                                                        <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                            <input type="hidden" name="paymentList[<?php echo $_smarty_tpl->tpl_vars['i']->value+1;?>
]['payment-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_payment;?>
">
...
} else { ?>Choose delivery method from a delivery list to which you want to assign payment methods.<?php }?>
                    </div>
                <?php }?>
            </div><!-- end col -->
        </div><!-- end row -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="background-color:transparent;padding: 45px 0;border: 0;">                    
            <div class="modal-body" style="background-color:transparent;">
                <div class="row">
                    <div class="col-lg-12">
                        <?php if (!empty($_smarty_tpl->tpl_vars['paymentList']->value)) {?>
                            <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">
                            <?php if (!empty($_smarty_tpl->tpl_vars['store_section_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_']->value, 'UTF-8');
} else { ?>PAYMENT LIST<?php }?>
                            &nbsp;<span class="badge"><?php echo count($_smarty_tpl->tpl_vars['paymentList']->value);?>
</span>
                        </h3>
                    </div>
                    <div class="panel-body panel-body-table">
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_catalog_table_header_add']->value, 'UTF-8');
                                ...
                                <tbody>
                                    <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['paymentList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
...
echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
                                            ...
                                            <td class="text-center">
                                                <button type="button" data-payment-id="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_payment;?>
