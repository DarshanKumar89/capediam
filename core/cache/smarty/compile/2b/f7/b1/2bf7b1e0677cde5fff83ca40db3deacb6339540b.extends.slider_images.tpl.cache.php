<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-01-19 17:58:54
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/slider/slider_images.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5880f04ee582d7_51226850',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5880f04ee582d7_51226850')) {function content_5880f04ee582d7_51226850($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/public/carpedmfashion.com/core/lib/smarty/plugins/modifier.truncate.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
    <a href="#" onclick="return false;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_section_slider_images']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_slider_images']->value;
} else { ?>IMages<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_slider_images']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_slider_images']->value;
} else { ?>Images<?php }?>
    </a>
</li>
<li class="active">
    <a href="cpanel/slider-edit/<?php echo $_smarty_tpl->tpl_vars['sliderId']->value;?>
">
    ...
    <h6 style="margin-left:15px;">
        <?php if (!empty($_smarty_tpl->tpl_vars['global_drive_header_folder_structure']->value)) {
echo $_smarty_tpl->tpl_vars['global_drive_header_folder_structure']->value;
} else { ?>Folder Structure<?php }?>
    </h6>
    <ul class="breadcrumb">
        <li>
            <a href="cpanel/slider-images/<?php echo $_smarty_tpl->tpl_vars['sliderId']->value;?>
/7259b712f116a7fe6310cdc765c836af">
                ROOT
            </a>
        </li>
        <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['imageList']->value['foldersStructure']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
">
    ...
    <div class="page-title">                    
        <h2>
            ...
            <h2><?php if (!empty($_smarty_tpl->tpl_vars['global_section_slider']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_slider']->value;
} else { ?>Slider<?php }?>&nbsp;<span style="font-size: .7em;color:red;"><sup>Beta</sup></span></h2>
        </h2>
    </div>
...
<div class="row">
    <div class="col-lg-12">
        <form role="form" action="cpanel/insert-slider-images" method="post">
            <input type="hidden" name="slider-id" value="<?php echo $_smarty_tpl->tpl_vars['sliderId']->value;?>
" />
...
echo $_smarty_tpl->tpl_vars['global_form_button_save']->value;
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['imageList']->value['folders'])&&(is_array($_smarty_tpl->tpl_vars['imageList']->value['folders'])&&(count($_smarty_tpl->tpl_vars['imageList']->value['folders'])>0))) {?>
              <div id="glr-folders">
                <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['imageList']->value['folders']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
                    <a  href="cpanel/slider-images/<?php echo $_smarty_tpl->tpl_vars['sliderId']->value;?>
...
">
            ...
            <?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['imageList']->value['files'])&&(is_array($_smarty_tpl->tpl_vars['imageList']->value['files'])&&(count($_smarty_tpl->tpl_vars['imageList']->value['files'])>0))) {?>
              <div class="gallery" id="links">
                  <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['imageList']->value['files']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
...
" style="width:auto;height:auto;max-width: 240px;margin-top:16px;margin-right:16px;padding:0;" data-gallery>
                          <div class="image">                              
                              <img src="<?php echo $_smarty_tpl->tpl_vars['item']->value->file_url;?>
" style="display:inline-block;max-width: 240px;max-height: 160px;margin: 0 auto;" alt="<?php echo $_smarty_tpl->tpl_vars['item']->value->file_name;?>
"/>                                        
...
" />
                          ...
                          <div class="meta">
                            <strong><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['item']->value->file_name,30,"...",true);?>
</strong>
                          </div>                                
                      </a>
                  <?php } ?>
