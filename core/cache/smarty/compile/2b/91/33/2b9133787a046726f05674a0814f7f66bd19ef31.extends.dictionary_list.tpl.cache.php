<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-05-16 20:20:01
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/dictionary/dictionary_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:44069463573a2b714f9635-21832937%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '78d3d51056e5484b14def7282e836cc6ffce4982' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/dictionary/dictionary_list.tpl',
      1 => 1460547443,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '44069463573a2b714f9635-21832937',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_573a2b715dc601_78397657',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573a2b715dc601_78397657')) {function content_573a2b715dc601_78397657($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<?php if ($_smarty_tpl->tpl_vars['user']->value->rule==1) {?>
    <div class="row">
        <div class="col-lg-12">
            <form id="dictionaryForm" action="cpanel/create-dictionary-item" method="post" role="form">
                <div class="panel panel-default panel-toggled">
                    <div class="panel-heading">                                
                        <h3 class="panel-title">
                            <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_new_element']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_new_element']->value, 'UTF-8');
} else { ?>NEW ELEMENT<?php }?>
                        </h3>  
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_section']->value)) {
echo $_smarty_tpl->tpl_vars['global_dictionary_table_header_section']->value;
} else { ?>Section<?php }?>
                                    </label>
                                ...
                                <div class="form-group">
                                    <label>
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_block']->value)) {
echo $_smarty_tpl->tpl_vars['global_dictionary_table_header_block']->value;
} else { ?>Block<?php }?>
                                    </label>
                                    <input type="text" name="block" value="" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_key']->value)) {
echo $_smarty_tpl->tpl_vars['global_dictionary_table_header_key']->value;
} else { ?>Key<?php }?>
                                    </label>
...
?>
                                                <li <?php if ($_smarty_tpl->tpl_vars['i']->value==0) {?>class="active"<?php }?>>
                                                    <a href="#tab-footer-<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
...
$_smarty_tpl->tpl_vars['lang']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['lang']->key;
?>
                                                <div class="tab-pane <?php if ($_smarty_tpl->tpl_vars['i']->value==0) {?>active<?php }?>" id="tab-footer-<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
">
                                                    <div class="form-group">
                                                        <div class="col-lg-12">
...
" style="width:23px;height:23px;"></span>
                                                                ...
                                                                <textarea  name="translate[<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
]['value']" rows="5" class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_form_button_clear_form']->value, 'UTF-8');
                        ...
                        <button type="button" class="btn btn-info" onclick="jvalidate.resetForm();">
                            <i class="fa fa-bug"></i>&nbsp;<?php if (!empty($_smarty_tpl->tpl_vars['global_form_button_reset_errors']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_form_button_reset_errors']->value, 'UTF-8');
} else { ?>RESET ERROR/ERRORS<?php }?>
                        </button>
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <?php if (count($_smarty_tpl->tpl_vars['languageList']->value)>0) {?>
                <?php if (count($_smarty_tpl->tpl_vars['dictionary']->value)>0) {?>
                    <form action="cpanel/update-dictionary-items" method="post" role="form">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <h3 class="panel-title">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_element_list']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_element_list']->value, 'UTF-8');
} else { ?>ELEMENT LIST<?php }?>&nbsp;
                                    <?php if (count($_smarty_tpl->tpl_vars['dictionary']->value)>0) {?>&nbsp;<span class="badge"><?php echo $_smarty_tpl->tpl_vars['pagination_info']->value;?>
</span><?php }?>
                                </h3>  
                            </div>
                            <div class="panel-body panel-body-table">
                                <div class="row">
                                    <div class="col-lg-12 col-sm-12 col-xs-12" style="padding:15px 10px;">
                                        <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                            <select class="form-control select" onchange="location = 'cpanel/dictionary-list/1/'+this.options[this.selectedIndex].value;">
                                        ...
                                        <div class="form-group pull-left" style="width:400px;margin-right:5px;">
                                            <div class="input-group">
                                                ...
                                                <span class="input-group-btn">
                                                    <button type="button" onclick="location = 'cpanel/dictionary-list/1/10?q='+document.getElementById('search').value;" class="btn btn-default">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="150" class="text-left">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_section']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_section']->value, 'UTF-8');
} else { ?>Section<?php }?>
                                                </th>
                                                <th width="150" class="text-left">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_block']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_block']->value, 'UTF-8');
} else { ?>Block<?php }?>
                                                </th>
                                                <th width="150" class="text-center">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_lang']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_lang']->value, 'UTF-8');
} else { ?>Language<?php }?>
                                                </th>
                                                <th width="250" class="text-left">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_key']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_key']->value, 'UTF-8');
} else { ?>Key<?php }?>
                                                </th>
                                                <th width="100" class="text-left">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_value']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_value']->value, 'UTF-8');
} else { ?>Value<?php }?>
                                                </th>
                                                <th width="100" class="text-center">
                                                    <?php if (!empty($_smarty_tpl->tpl_vars['global_dictionary_table_header_remove']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_dictionary_table_header_remove']->value, 'UTF-8');
} else { ?>REMOVE<?php }?>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php  $_smarty_tpl->tpl_vars[\'item\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'item\']->_loop = false;
 $_smarty_tpl->tpl_vars[\'i\'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars[\'dictionary\']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, \'array\');}
foreach ($_from as $_smarty_tpl->tpl_vars[\'item\']->key => $_smarty_tpl->tpl_vars[\'item\']->value) {
$_smarty_tpl->tpl_vars[\'item\']->_loop = true;
 $_smarty_tpl->tpl_vars[\'i\']->value = $_smarty_tpl->tpl_vars[\'item\']->key;
?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                    <tr>
                                                        <td class="text-center" style="font-weight:700;color:#660000;">
                                                            <input type="hidden" name="itemList[<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'i\']->value;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
]['id']" value="<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'item\']->value->id_dictionary;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
">
                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'i\']->value+1;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                        </td>
                                                        <td class="text-left"><?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'item\']->value->section;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
</td>
                                                        <td class="text-left"><?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'item\']->value->block;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
</td>
                                                        <td class="text-center">
                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php  $_smarty_tpl->tpl_vars[\'lang\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'lang\']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars[\'languageList\']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, \'array\');}
foreach ($_from as $_smarty_tpl->tpl_vars[\'lang\']->key => $_smarty_tpl->tpl_vars[\'lang\']->value) {
$_smarty_tpl->tpl_vars[\'lang\']->_loop = true;
?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                                <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php if ($_smarty_tpl->tpl_vars[\'lang\']->value->id_lang==$_smarty_tpl->tpl_vars[\'item\']->value->l_key) {?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                                    <span class="flag-icon flag-icon-<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value->language_code;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
" style="width:23px;height:23px;"></span>
                                                                <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php }?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php } ?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                        </td>
                                                        <td class="text-left"><?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'item\']->value->t_key;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
</td>
                                                        <td class="text-center">
                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php  $_smarty_tpl->tpl_vars[\'lang\'] = new Smarty_Variable; $_smarty_tpl->tpl_vars[\'lang\']->_loop = false;
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="input-group">
                                                                            <span class="input-group-addon">
                                                                                <span class="flag-icon flag-icon-<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'lang\']->value->language_code;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
" style="position: relative;top: -3px;width:23px;height:23px;"></span>
                                                                            </span>
                                                                            <textarea name="itemList[<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'i\']->value;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
]['translate']" class="form-control" rows="1"><?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'item\']->value->t_value;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
</textarea>
                                                                        </div>
                                                                    </div>
                                                        ...
                                                        <td class="text-center">
                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php if ($_smarty_tpl->tpl_vars[\'user\']->value->rule==1) {?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>

                                                                <label class="switch">
                                                                    <input type="checkbox" name="itemList[<?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php echo $_smarty_tpl->tpl_vars[\'i\']->value;?>
/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
]['remove']" value="1">
                                                                    <span></span>
                                                                </label>
                                                            <?php echo '/*%%SmartyNocache:44069463573a2b714f9635-21832937%%*/<?php } else { ?>/*/%%SmartyNocache:44069463573a2b714f9635-21832937%%*/';?>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_form_button_save_changes']->value, 'UTF-8');
                ...
                <?php } else { ?>
                    <div class="alert alert-info" role="alert">
                        <strong>INFO!</strong> There are no items.
                    </div>
                <?php }?>
            <?php } else { ?>
                <div class="alert alert-warning" role="alert">
