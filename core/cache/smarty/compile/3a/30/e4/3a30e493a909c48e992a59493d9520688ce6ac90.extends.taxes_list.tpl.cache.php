<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-06 19:40:09
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/taxes/taxes_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15873444158470609109f89-79428250%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ad954ae9422acfc000fa368c304fd2613882286' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/taxes/taxes_list.tpl',
      1 => 1469707246,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '15873444158470609109f89-79428250',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_584706093fde38_86377247',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584706093fde38_86377247')) {function content_584706093fde38_86377247($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    ...
    <div class="page-title">                    
        <h2>Taxes&nbsp;<span style="font-size: .7em;color:red;"><sup>Beta</sup></span></h2>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <form id="taxes-form" action="cpanel/store/localization/taxes/create" method="post" role="form">
            <div class="panel panel-default panel-toggled">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title">NEW TAX</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tax-name" value="" class="form-control" required>
                                <span class="help-block">Tax name to display in carts and on invoices (e.g. &quot;VAT&quot;). - Invalid characters <>;=#{ }.</span>
                            </div>
                            <div class="form-group">
                                <label>Rate<span style="color:red;">*</span></label>
                                <input type="text" name="rate" value="" class="form-control" required>
                                <span class="help-block">Format: XX.XX or XX.XXX (e.g. 19.60 or 13.925) - Invalid characters <>;=#{ }.</span>
                            </div>
                        </div><!-- end col -->
                        <div class="col-lg-6">
...
<div class="row">
    <div class="col-md-12">
        <?php if (!empty($_smarty_tpl->tpl_vars['taxesList']->value)) {?>
            <form action="cpanel/store/localization/taxes/update-all" method="post" role="form">
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">TAXES&nbsp;<span class="badge"><?php echo $_smarty_tpl->tpl_vars['taxesCount']->value;?>
</span></h3>
                        <ul class="panel-controls">
                            <li>
                                <a href="#" onclick="return false;" class="panel-collapse">
 ...
 $_from = $_smarty_tpl->tpl_vars['taxesList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                        <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="taxes[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['tax-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_tax;?>
"/>
                                                <?php echo $_smarty_tpl->tpl_vars['item']->value->id_tax;?>

                                            </td>
                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->tax_name;?>
</td>
                                            <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['item']->value->rate;?>
</td>
                                            <td class="text-center">
                                                <a href="cpanel/store/localization/taxes/edit/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_tax;?>
" class="btn btn-block btn-info" title="<?php echo $_smarty_tpl->tpl_vars['item']->value->tax_name;?>
">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="taxes[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
        ...
        <?php } else { ?>
             <div class="alert alert-info" role="alert">
                <strong>INFO!</strong> You have no taxes.
            </div>
        <?php }?>
    </div><!-- end col -->
</div><!-- end row -->
...
<?php echo '<script'; ?>
 type="text/javascript">
    var jvalidate = $("#taxes-form").validate({
        ignore: [],
        rules: {                                            
            'tax-name': {
                required: true,
