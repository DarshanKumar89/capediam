<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-09-08 09:59:50
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/article_images.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57d11a76c03790_74707339',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57d11a76c03790_74707339')) {function content_57d11a76c03790_74707339($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/public/carpedmfashion.com/core/lib/smarty/plugins/modifier.truncate.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
    <a href="#" onclick="return false;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_section_article_image']->value)) {
echo $_smarty_tpl->tpl_vars['store_section_article_image']->value;
} else { ?>Article image<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['store_section_article_image']->value)) {
echo $_smarty_tpl->tpl_vars['store_section_article_image']->value;
} else { ?>Article image<?php }?>
    </a>
</li>
...
" title="<?php echo $_smarty_tpl->tpl_vars['article_name']->value;?>
">
        <?php echo $_smarty_tpl->tpl_vars['article_name']->value;?>
...
echo $_smarty_tpl->tpl_vars['global_drive_header_folder_structure']->value;
    ...
    <ul class="breadcrumb">
        <li>
            <a href="cpanel/store/catalog/article/choose-image/<?php echo $_smarty_tpl->tpl_vars['articleId']->value;?>
...
<div class="row">
    <div class="col-lg-12">
        <form role="form" action="cpanel/store/catalog/article/image-save" method="post">
            <input type="hidden" name="article-id" value="<?php echo $_smarty_tpl->tpl_vars['articleId']->value;?>
" />
...
" />
                        ...
                        <div class="meta">
                            <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->file_name;?>
</strong>
                        </div>                                
                    </a>
                <?php } ?>
