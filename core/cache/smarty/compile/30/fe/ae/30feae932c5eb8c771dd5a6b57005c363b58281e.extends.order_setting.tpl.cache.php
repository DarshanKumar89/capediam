<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-11-25 09:25:06
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/orders/order_setting.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5837f56367b4a3_98250574',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5837f56367b4a3_98250574')) {function content_5837f56367b4a3_98250574($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <?php if (is_null($_smarty_tpl->tpl_vars['statusList']->value)||empty($_smarty_tpl->tpl_vars['statusList']->value)) {?>
...
echo $_smarty_tpl->tpl_vars['global_alert_info']->value;
        ...
        Priraďte stavy objednávok zo zoznamu stavov v poradí, v akom chcete mať 
        zoradené svoje objednávky. Priradíte ich kliknutím na tlačidlo Plus (+) nižšie na pravej strane panelu.
      </div>
    <?php }?>
  </div><!-- end col -->
</div><!-- end row -->
    ...
    <form action="cpanel/store/orders/ordering-setting-rules"  method="post" role="form">
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">
                <h3 class="panel-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
} else { ?>ORDER - LIST OF SETTINGS<?php }?></h3>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
                                ...
                                <th width="200" class="text-center">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
} else { ?>AUTO SENDEMAIL<?php }?>
                                </th>
                                <th width="200" class="text-center">
                                    <?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
} else { ?>AUTO NOTIFY<?php }?>
                                </th>
...
?>
                                <tr data-sn="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_rule;?>
">
                                    <td class="text-center" style="font-weight:700;color:#660000;">
                                        <input type="hidden" name="o-settings[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
"/>
                                    ...
                                    <td class="text-center">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->email_name)) {?>
                                    ...
                                    <td class="text-center">
                                        <?php if ($_smarty_tpl->tpl_vars['item']->value->is_auto_sendemail==1) {?>
                                            <span style="font-size:1.4em;font-weight:700;color:green;">
                                                <i class="fa fa-check"></i>
                                            </span>
                                        <?php } else { ?>
                                    ...
                                    <td class="text-center">
                                        <?php if ($_smarty_tpl->tpl_vars['item']->value->is_auto_notify==1) {?>
                                            <span style="font-size:1.4em;font-weight:700;color:green;">
                                                <i class="fa fa-check"></i>
                                            </span>
                                        <?php } else { ?>
                                    ...
                                    <td class="text-center">
                                        <a href="cpanel/store/orders/remove-setting-rule/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_rule;?>
" class="btn btn-warning" title="Remove Setting Rule">
