<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-01-11 16:11:50
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/attribute/attribute_assigning_value_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:164517148158764b36928957-74272081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '87079f6371ed140956bb396ce16d350414110c1d' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/attribute/attribute_assigning_value_list.tpl',
      1 => 1469707239,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '164517148158764b36928957-74272081',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58764b37051b41_28668780',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58764b37051b41_28668780')) {function content_58764b37051b41_28668780($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['store_section_attributes']->value;
  ...
  <li class="active">
    <a href="cpanel/store-attribute-assigning-value-list" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value)) {
echo $_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value;
} else { ?>Assigning values<?php }?>">
      <?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value)) {
echo $_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value;
} else { ?>Assigning values<?php }?>
    </a>
  </li>
  ...
  <div class="page-title">
    <h2>
      <?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_attributes_section_assigning_values']->value, 'UTF-8');
} else { ?>ASSIGNING VALUES<?php }?>
        ...
        <div class="panel-body panel-body-form">
          <div class="col-lg-4 col-md-4 col-sm-12 col-xs12">
            <div class="form-group">
              <label><?php if (!empty($_smarty_tpl->tpl_vars['store_section_attributes']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_attributes']->value, 'UTF-8');
} else { ?>Attributes<?php }?></label>
              <select name="attribute-id" class="form-control select" data-live-search="true" onchange="location = 'cpanel/store-attribute-assigning-value-list/'+this.options[this.selectedIndex].value;" required>
...
<form id="deleteAttributeValueListForm" action="cpanel/store-delete-attribute-value-list" method="post" role="form">
  <input type="hidden" name="attribute-id" value="<?php echo $_smarty_tpl->tpl_vars['attrId']->value;?>
" />
  <div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      <?php if (isset($_smarty_tpl->tpl_vars['attrId']->value)&&((int) $_smarty_tpl->tpl_vars['attrId']->value>0)) {?>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_attributes_form_label_value_list']->value, 'UTF-8');
            ...
            <ul class="panel-controls">
              <li>
                <a href="cpanel/store-create-attribute-value-form/<?php echo $_smarty_tpl->tpl_vars['attrId']->value;?>
" title="Create Attribute Value">
          ...
          <div class="panel-body panel-body-table">
            <?php if (is_array($_smarty_tpl->tpl_vars['attributeValueList']->value)&&(count($_smarty_tpl->tpl_vars['attributeValueList']->value)>0)) {?>
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:15px 10px;">
                  <div class="form-group pull-left" style="width:150px;margin-right:5px;">
                    <select id="control" class="form-control select">
                  ...
                  <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                    <select class="form-control select" onchange="location = 'cpanel/store-attribute-assigning-value-list/<?php echo $_smarty_tpl->tpl_vars['attrId']->value;?>
/1/'+this.options[this.selectedIndex].value;">
              ...
              <div class="table-responsive" style="border-top:1px solid #E5E5E5;">
                <table id="attrValueList" class="table table-bordered table-striped table-actions">
                  <thead>
                  <tr>
                    <th width="80" class="text-center">#</th>
                    <?php if ($_smarty_tpl->tpl_vars['user']->value->rule==1) {?>
                      <th width="120" class="text-center">
                        <?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_table_header_id']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_attributes_table_header_id']->value, 'UTF-8');
} else { ?>ID<?php }?>
                      </th>
                    <?php }?>
                    <th class="text-left">
                      <?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_table_header_value']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_attributes_table_header_value']->value, 'UTF-8');
} else { ?>VALUE<?php }?>
                    </th>
...
?>
                    <tr>
                      <td class="text-center" style="font-weight:700;color:#660000;">
                        <input type="hidden" name="valueList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['value-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_value;?>
"/>
                        <input type="checkbox" name="valueList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['on']" value="1">
                      </td>
                      <?php if ($_smarty_tpl->tpl_vars['user']->value->rule==1) {?>
                      ...
                      <td class="text-center">
                        <a <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->path)) {?>href="<?php echo $_smarty_tpl->tpl_vars['item']->value->tree;
...
"
                          <?php if (is_null($_smarty_tpl->tpl_vars['item']->value->path)) {?>disabled<?php }?>
                          >
                          <span style="display:inline-block;float:left;"><i class="fa fa-eye"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->value;?>
</span>
                        </a>
                      </td>
                      <td class="text-center">
                        <a href="cpanel/store-update-attribute-value-form/<?php echo $_smarty_tpl->tpl_vars['attrId']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_value;?>
" class="btn btn-info" style="padding:7px;border-radius:100%;" title="Update Attribute Value From">
                          <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                        </a>
                      </td>
                      <td class="text-center">
                        <a href="cpanel/store-delete-attribute-value/<?php echo $_smarty_tpl->tpl_vars['attrId']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_value;?>
" class="btn btn-danger" title="Delete Attribute Value">
            ...
            <?php } else { ?>
              <div class="alert alert-info" style="float:none;width: 99%;margin: .5% auto;" role="alert">
...
echo $_smarty_tpl->tpl_vars['global_alert_info']->value;
                ...
                Mometálne nemáte vytvorenú žiadnu hodnotu k vybranej vlastnosťi.Pre vytvorenie hodnoty kliknite v pravo hore na plus.
              </div>
            <?php }?>
          </div><!-- end panel-body -->
          <?php if (is_array($_smarty_tpl->tpl_vars['attributeValueList']->value)&&(count($_smarty_tpl->tpl_vars['attributeValueList']->value)>0)) {?>
...
echo $_smarty_tpl->tpl_vars['global_alert_info']->value;
          ...
          <?php if (!empty($_smarty_tpl->tpl_vars['store_attributes_alert_choose_attribute_value']->value)) {
echo $_smarty_tpl->tpl_vars['store_attributes_alert_choose_attribute_value']->value;
} else { ?>Select the desired attribute from the list of attributes.<?php }?>
        </div>
      <?php }?>
    </div><!-- end col -->
  </div><!-- end row -->
...
$(function() {
  $('#control').on('change', function() {
    ...
    if(value !== 0) {
      $('#attrValueList').find('[type="checkbox"]').each(function() {
