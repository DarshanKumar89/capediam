<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-10-24 11:20:52
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/unfiled_pages_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_580dd2743ba482_79405318',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580dd2743ba482_79405318')) {function content_580dd2743ba482_79405318($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/public/carpedmfashion.com/core/lib/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_section_pages_site_structure']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_pages_site_structure']->value;
} else { ?>Site structure<?php }?>">
    <a href="cpanel/page-list-by-site-structure">
       <?php if (!empty($_smarty_tpl->tpl_vars['global_section_pages_site_structure']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_pages_site_structure']->value;
} else { ?>Site structure<?php }?>
    </a>
</li>
...
echo $_smarty_tpl->tpl_vars['global_pages_button_create_page']->value;
} else { ?>Create Page<?php }?>
            </button>
            <button type="button" class="btn btn-primary">
                <?php if (!empty($_smarty_tpl->tpl_vars['global_pages_button_create_page_list']->value)) {
echo $_smarty_tpl->tpl_vars['global_pages_button_create_page_list']->value;
} else { ?>Create Page List<?php }?>
            </button>
        </div>
...
" id="pg-layte" class="col-lg-3" title="">
            <div class="pg-layte-i">
                <span class="fa fa-file-text-o fa-2x"></span>
            </div>
            <div class="pg-layte-t">
                <span><?php echo $_smarty_tpl->tpl_vars['item']->value->pagename;?>
</span>
                <span class="sub author">@<?php echo $_smarty_tpl->tpl_vars['item']->value->first_name;?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->last_name;?>
</span>
                <span class="sub title"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value->created,"%d-".((string)$_smarty_tpl->tpl_vars['m']->value)."-%Y");?>
</span>
            </div>
        </a>
    <?php } ?>
...
echo $_smarty_tpl->tpl_vars['global_pages_modal_window_new_page_title']->value;
} else { ?>New page<?php }?>
            </div>
...
echo $_smarty_tpl->tpl_vars['global_pages_label_page_name']->value;
} else { ?>Page name<?php }?>
                                </label>
