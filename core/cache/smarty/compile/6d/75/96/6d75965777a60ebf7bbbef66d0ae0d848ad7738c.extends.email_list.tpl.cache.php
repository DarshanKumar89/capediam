<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-01-16 16:28:18
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/email/email_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_587ce693588d37_10740440',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_587ce693588d37_10740440')) {function content_587ce693588d37_10740440($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
              ...
              <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <div class="form-group">
                  ...
                  <select name="widget-id" class="form-control select">
                    <option value="0" selected><?php if (isset($_smarty_tpl->tpl_vars['global_form_select_choose']->value)&&(strlen($_smarty_tpl->tpl_vars['global_form_select_choose']->value)>0)) {
...
if (($_smarty_tpl->tpl_vars['tabLang']->value->mode==2)&&($_smarty_tpl->tpl_vars['tabLang']->value->code==$_smarty_tpl->tpl_vars['lang']->value->id_lang)) {?>class="active"<?php }?>>
                        <a href="#tab-new-email-<?php echo $_smarty_tpl->tpl_vars['lang']->value->language_code;?>
...
if (($_smarty_tpl->tpl_vars['tabLang']->value->mode==2)&&($_smarty_tpl->tpl_vars['tabLang']->value->code==$_smarty_tpl->tpl_vars['lang']->value->id_lang)) {?>active<?php }?>" id="tab-new-email-<?php echo $_smarty_tpl->tpl_vars['lang']->value->language_code;?>
">
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
"></span>
                                ...
                                <input type="text" 
                                  name="data[<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
]['bcc']" 
                                  value="" 
...
"></span>
                                ...
                                <textarea name="data[<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
]['signature']" class="form-control" rows="9"></textarea>
                              </div><!-- end input-group -->
                            </div><!-- end form-group -->
                            <div class="panel panel-default nav-tabs-vertical">                   
                              ...
                              <div class="tabs">
                                <ul class="nav nav-tabs">
                                  <li class="active">
                                    <a href="#w_1_<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
" data-toggle="tab">
                                      OBJEDNÁVKA
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#w_2_<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
" data-toggle="tab">
                                      FAKTÚRA
                                    </a>
                                  </li>
                                ...
                                <div class="panel-body tab-content">
                                  <div class="tab-pane active" id="w_1_<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
">
                                  ...
                                  <div class="tab-pane" id="w_2_<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
">
...
" class="ckeditor" row="90"></textarea>
                              </div><!-- end input-group -->
                            </div><!-- end form-group -->
                          </div><!-- end col -->
                        </div><!-- end row -->
                      </div><!-- tab-new-email-<?php echo $_smarty_tpl->tpl_vars['lang']->value->language_code;?>
 -->
                    <?php } ?>
                  </div><!-- end panel-body -->
                </div><!-- end panel -->
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <?php if (isset($_smarty_tpl->tpl_vars['emailList']->value)&&(is_array($_smarty_tpl->tpl_vars['emailList']->value)&&(count($_smarty_tpl->tpl_vars['emailList']->value)>0))) {?>
      <form action="cpanel/update-emails" method="post" role="form">
        <div class="panel panel-default">
          <div class="panel-heading ui-draggable-handle">
            <span class="badge pull-left">
              <?php echo count($_smarty_tpl->tpl_vars['emailList']->value);?>
...
]['id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>
"/>
                        <?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>

                      </td>
                      <td class="text-left">
                        <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->email_name;?>
</strong>
                      </td>
                      <td class="text-center">
                        <a href="cpanel/update-email-form/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>
