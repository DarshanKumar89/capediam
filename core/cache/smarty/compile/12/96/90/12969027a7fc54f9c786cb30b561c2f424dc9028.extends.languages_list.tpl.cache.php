<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-27 13:24:45
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/languages/languages_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7547371625798b61de72da5-06440825%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '53375118c65bf9140079cdb186bb8591fff868d9' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/languages/languages_list.tpl',
      1 => 1469528891,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '7547371625798b61de72da5-06440825',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5798b61e01cab3_93038276',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5798b61e01cab3_93038276')) {function content_5798b61e01cab3_93038276($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <div class="panel panel-default">
            <div class="panel-heading ui-draggable-handle">
                ...
                <h3 class="panel-title">
                    <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_language_list']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_language_list']->value, 'UTF-8');
} else { ?>LANGUAGE LIST<?php }?>&nbsp;
                    <?php if (count($_smarty_tpl->tpl_vars['languageList']->value)>0) {?>&nbsp;<span class="badge"><?php echo $_smarty_tpl->tpl_vars['pagination_info']->value;?>
</span><?php }?>
                </h3>                               
            </div>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th width="200" class="text-left">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_lang_name']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_lang_name']->value, 'UTF-8');
} else { ?>LANGUAGE NAME<?php }?>
                                    </th>
                                    <th width="200" class="text-left">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_country_name']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_country_name']->value, 'UTF-8');
} else { ?>COUNTRY NAME<?php }?>
                                    </th>
                                    <th width="50" class="text-center">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_country_code']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_country_code']->value, 'UTF-8');
} else { ?>COUNTRY CODE<?php }?>
                                    </th>
                                    <th width="50" class="text-center">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_iso_code']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_iso_code']->value, 'UTF-8');
} else { ?>ISO CODE<?php }?>
                                    </th>
                                    <th width="50" class="text-center">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_lang_code']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_lang_code']->value, 'UTF-8');
} else { ?>LANGUAGE CODE<?php }?>
                                    </th>
                                    <th width="100" class="text-center">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_languages_table_header_enable']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_languages_table_header_enable']->value, 'UTF-8');
} else { ?>ENABLE<?php }?>
                                    </th>
                                </tr>
                            </thead>
...
?>
                                <tr>
                                  <td class="text-center"> 
                                    <input type="hidden" name="languageList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['id-lang']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_lang;?>
" />
                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->id_lang;?>
                                  ...
                                  <td class="text-center">
                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->iso_code;?>
                                  ...
                                  <td class="text-center">
                                    <label class="switch">
                                      <input type="checkbox" name="languageList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['active']" value="1" <?php if ($_smarty_tpl->tpl_vars['item']->value->active) {?>checked<?php }?>>
                                      <span></span>
                                    </label>
                                  </td>
                                </tr>
                ...
                <?php } else { ?>
                  <div class="col-lg-12 col-sm-12 col-xs-12" style="margin: 15px auto;">
