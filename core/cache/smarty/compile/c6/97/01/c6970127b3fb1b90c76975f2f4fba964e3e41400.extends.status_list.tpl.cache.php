<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-06 05:40:48
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/statuses/status_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29359091158464150473097-52697911%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '71009e5288c76ca7d19266a75163a87e2e967fca' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/statuses/status_list.tpl',
      1 => 1469707249,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '29359091158464150473097-52697911',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58464150d8eae5_98921239',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58464150d8eae5_98921239')) {function content_58464150d8eae5_98921239($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['store_section_statuses']->value;
    ...
    <div class="page-title">                    
        <h2>
            <i class="fa fa-heartbeat"></i>&nbsp;
            <?php if (!empty($_smarty_tpl->tpl_vars['store_section_statuses']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_statuses']->value, 'UTF-8');
} else { ?>Statuses<?php }?>&nbsp;
    ...
    <div class="col-lg-12">
        <div class="btn-group" role="group">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#create-status" role="menuitem">
                <i class="fa fa-plus"></i>
                <span><?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_controls_new_status']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_controls_new_status']->value;
} else { ?>New status<?php }?></span>
            </button>
        </div>
    </div><!-- end col -->
</div><!-- end row -->
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="widget widget-info widget-padding-sm">                            
            <div class="widget-item-left">
                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_article;?>
%" data-readOnly="true" data-thickness=".2"/>
            </div>
            <div class="widget-data">
                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_article;?>
</span>%</div>
                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_widget_article']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_widget_article']->value;
} else { ?>Article<?php }?></div>                             
            </div>                                                        
        </div> 
    </div><!-- end col -->
    <div class="col-lg-3 col-sm-6">
        <div class="widget widget-success widget-padding-sm">                            
            <div class="widget-item-left">
                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_shopping_cart;?>
%" data-readOnly="true" data-thickness=".2"/>
            </div>
            <div class="widget-data">
                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_shopping_cart;?>
</span>%</div>
                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_widget_shopping_cart']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_widget_shopping_cart']->value;
} else { ?>Shopping cart<?php }?></div>                               
            </div>                                                        
        </div> 
    </div><!-- end col -->
    <div class="col-lg-3 col-sm-6">
        <div class="widget widget-warning widget-padding-sm">                            
            <div class="widget-item-left">
                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_order;?>
%" data-readOnly="true" data-thickness=".2"/>
            </div>
            <div class="widget-data">
                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_order;?>
</span>%</div>
                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_widget_order']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_widget_order']->value;
} else { ?>Order<?php }?></div>                          
            </div>                                                       
        </div> 
    </div><!-- end col -->
    <div class="col-lg-3 col-sm-6">
        <div class="widget widget-primary widget-padding-sm">                            
            <div class="widget-item-left">
                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_warehouse;?>
%" data-readOnly="true" data-thickness=".2"/>
            </div>
            <div class="widget-data">
                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value->number_of_warehouse;?>
</span>%</div>
                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_widget_warehouse']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_widget_warehouse']->value;
} else { ?>Warehouse<?php }?></div>                              
            </div>                                                      
        </div> 
    </div><!-- end col -->
</div><!-- end row -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title">
                            <?php if (!empty($_smarty_tpl->tpl_vars['store_section_status_list']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_status_list']->value, 'UTF-8');
} else { ?>STATUS LIST<?php }?>&nbsp;
                            <span class="badge"></span>
                        </h3>
                        <ul class="panel-controls">
                            <li>
                                <a href="cpanel/store/statuses/0/0" style="background-color:#000;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_label_all']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_label_all']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/statuses/0/1" style="background-color:#3fbae4;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_article']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_article']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/statuses/0/2" style="background-color:#fea223;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_cart']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_cart']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/statuses/0/3" style="background-color:#95b75d;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_order']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_order']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/statuses/0/4" style="background-color:#b64645;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_modal_window_form_label_option_warehouse']->value)) {
...
} else { ?>STATUS GROUP<?php }?>
                                        </th>
                                        <th class="text-left">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_table_header_status_name']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_statuses_table_header_status_name']->value, 'UTF-8');
...
?>
                                        <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;border-left: 1.5px solid <?php echo $_smarty_tpl->tpl_vars['item']->value->color;?>
;border-bottom: 1.5px solid <?php echo $_smarty_tpl->tpl_vars['item']->value->color;?>
;">
                                               <input type="hidden" name="statuses[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['status-id']" value='<?php echo $_smarty_tpl->tpl_vars['item']->value->id_status;?>
'/>
                                               <?php echo $_smarty_tpl->tpl_vars['item']->value->id_status;?>

                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator center <?php if ($_smarty_tpl->tpl_vars['item']->value->id_pattern==1) {?>blue<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_pattern==2) {?>orange<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_pattern==3) {?>green<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_pattern==4) {?>red<?php } else { ?>black<?php }?>">
                                                    <i class="fa fa-bullseye"></i>
                                                </span>
                                            </td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="renderEdit(<?php echo $_smarty_tpl->tpl_vars['item']->value->id_status;?>
...
">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="statuses[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['enable']" <?php if ($_smarty_tpl->tpl_vars['item']->value->enabled==1) {?>checked=""<?php }?> value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_alert_info']->value, 'UTF-8');
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_alert_no_statuses']->value)) {
echo $_smarty_tpl->tpl_vars['store_statuses_alert_no_statuses']->value;
} else { ?>There are no statuses.<?php }?>
            </div>
        <?php }?>
    </div><!-- end col -->
</div><!-- end row -->
                ...
                <form id="createStatusForm" action="cpanel/store/status/create" method="post" role="form">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <strong>
                                    <?php if (!empty($_smarty_tpl->tpl_vars['store_statuses_modal_window_new_status']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_statuses_modal_window_new_status']->value, 'UTF-8');
} else { ?>NEW STATUS<?php }?>
                                </strong> 
                            </h3>
...
]['status-name']" value="" class="form-control" minlength="3" maxlength="150" required="">
                                                                <span class="input-group-addon">
                                                                    <i class="fa fa-file-text-o"></i>
                                                                </span>
                                                            </div>
