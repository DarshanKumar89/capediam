<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-21 05:39:51
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/orders/order_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_585a079768a9a0_22881512',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_585a079768a9a0_22881512')) {function content_585a079768a9a0_22881512($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-lg-3 col-sm-6">
        <div class="widget widget-warning widget-padding-sm">                            
            ...
            <div class="widget-data">
                ...
                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_users_widget_']->value)) {
echo $_smarty_tpl->tpl_vars['store_users_widget_']->value;
} else { ?>Average Order Value<?php }?></div>                          
            </div>                                                       
        </div> 
    </div><!-- end col -->
    <div class="col-lg-3 col-sm-6">
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_']->value, 'UTF-8');
                        ...
                        <ul class="panel-controls">
                            <li>
                                <a href="cpanel/store/orders/list/0/0" style="background-color:#000;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_label_all']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_label_all']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/orders/list/0/1" style="background-color:#3fbae4;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/orders/list/0/2" style="background-color:#fea223;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>CLOSED<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            ...
                            <li>
                                <a href="cpanel/store/orders/list/0/3" style="background-color:#95b75d;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>ARCHIVED<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            ...
                            <li>
                                <a href="cpanel/store/orders/list/0/4" style="background-color:#b64645;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>WAIT FOR PAY<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            </li>
                            <li>
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="padding:15px 10px;">
                                <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                    <select class="form-control select" onchange="location = 'cpanel/store/orders/list/<?php echo $_smarty_tpl->tpl_vars['filterA']->value;?>
...
"/>
                                            ...
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <?php echo $_smarty_tpl->tpl_vars['item']->value->id_cart;?>
                                            ...
                                            <td class="text-center">
                                                <span class="circle-indicator <?php if ($_smarty_tpl->tpl_vars['item']->value->is_locked==0) {?>blue<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->is_locked==1) {?>orange<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->is_archive==1) {?>green<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->is_recyclable==1) {?>red<?php } else { ?>black<?php }?>">
                                                    <i class="fa fa-bullseye"></i>
                                                </span>
                                            </td>
                                            <td class="text-center">
...
" style="position: relative;top: -7px;width:23px;height:23px;"></span>
                                            ...
                                            <td class="text-center">
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->newClient==true) {?>
                                            ...
                                            <td <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->address)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
...
$_smarty_tpl->tpl_vars['contact']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['contact']->key;
?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['contact']->value->last_name;?>
                                                        ...
                                                        <?php }?>
                                                        <?php if ($_smarty_tpl->tpl_vars['item']->value->id_address_primary==0&&$_smarty_tpl->tpl_vars['item']->value->id_address_invoice==0&&$_smarty_tpl->tpl_vars['i']->value==0) {?>
                                                            <span style="font-size:1.4em;font-weight:700;color:orange;">
                                                                <i class="fa fa-ban"></i>
                                                            </span>
                                                        <?php }?>
                                            ...
                                            <td <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->delivery)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->delivery)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->delivery->delivery_name;?>
                                            ...
                                            <td class="text-right">
                                                <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->delivery)) {?>
                                                    <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->delivery->cost;?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->delivery->sign;?>
</strong>
                                                <?php } else { ?>
                                                    <strong>0.00&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->currency->sign;?>
</strong>
                                                <?php }?>
                                            </td>
                                            <td <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->payment)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->payment)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->payment->payment_name;?>
                                            ...
                                            <td class="text-right">
                                                <?php if (!is_null($_smarty_tpl->tpl_vars['item']->value->payment)) {?>
                                                    <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->payment->cost;?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->payment->sign;?>
</strong>
                                                <?php } else { ?>
                                                    <strong>0.00&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->currency->sign;?>
</strong>
...
echo $_smarty_tpl->tpl_vars['item']->value->currency->sign;?>
                                            ...
                                            <td class="text-center">
                                                <button type="button" onclick="showCartItems('<?php echo $_smarty_tpl->tpl_vars['item']->value->cart_secure_key;?>
');" class="btn btn-info btn-sm btn-block">
                                                    <i class="fa fa-eye"></i>
                                                    <strong><?php if (empty($_smarty_tpl->tpl_vars['item']->value->total_items)) {
echo $_smarty_tpl->tpl_vars['item']->value->cart->items;
} else {
echo $_smarty_tpl->tpl_vars['item']->value->total_items;
}?></strong>
                                                </button>
                                            </td>
                                        </tr>
