<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-05-09 14:43:59
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/catalog/category/category_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:16992365515730a22f794450-09616361%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b93091db78522aed699ad333b5d7454adf3e00fb' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/catalog/category/category_list.tpl',
      1 => 1460547461,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '16992365515730a22f794450-09616361',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5730a22f8a2ca7_51757078',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5730a22f8a2ca7_51757078')) {function content_5730a22f8a2ca7_51757078($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['store_section_categories']->value;
    ...
    <div class="page-title">                    
        <h2><?php if (!empty($_smarty_tpl->tpl_vars['store_section_categories']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_categories']->value, 'UTF-8');
} else { ?>CATEGORIES<?php }?>&nbsp;<span style="font-size: .7em;color:red;"><sup>Beta</sup></span></h2>
    </div>
...
<div class="row" style="margin-bottom: 25px;">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="btn-group" role="group">
            <a href="cpanel/store-create-category-form" class="btn btn-info" role="menuitem" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_new_category']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_new_category']->value;
} else { ?>New category<?php }?>">
                <i class="fa fa-plus"></i>
                <span><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_new_category']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_new_category']->value;
} else { ?>New category<?php }?></span>
            </a>
            <a href="cpanel/store-category-assigning-article-form" class="btn btn-success" role="menuitem" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_assingning_artcles']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_assingning_artcles']->value;
} else { ?>Assigning articles<?php }?>">
                <i class="fa fa-list"></i>
                <span><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_assingning_artcles']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_assingning_artcles']->value;
} else { ?>Assigning articles<?php }?></span>
            </a>
            <?php if ($_smarty_tpl->tpl_vars['user']->value->id_user==1) {?>
                <a href="cpanel/store/catalog/categories/external-assigning" class="btn btn-primary" role="menuitem" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_']->value;
} else { ?>Assigning articles on external categories<?php }?>">
                    <i class="fa fa-list"></i>
                    <span><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_controls_']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_controls_']->value;
} else { ?>Priraďovanie artiklov k externým kategóriam<?php }?></span>
                </a>
            <?php }?>
        </div>
    </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="widget widget-primary widget-padding-sm">                            
                            <div class="widget-item-left">
                                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value["disabled_categories"];?>
%" data-readOnly="true" data-thickness=".2"/>
                            </div>
                            <div class="widget-data">
                                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value["disabled_categories"];?>
</span>%</div>
                                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_widgets_disabled_categories']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_widgets_disabled_categories']->value;
} else { ?>Disabled Categories<?php }?></div>                             
                            </div>                                                        
                        </div> 
                    </div><!-- end col -->
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="widget widget-danger widget-padding-sm">                            
                            <div class="widget-item-left">
                                <input class="knob" data-width="100" data-height="100" data-min="0" data-max="100" data-displayInput=false data-bgColor="#C0C0C0" data-fgColor="#FFF" value="<?php echo $_smarty_tpl->tpl_vars['widgets']->value["empty_categories"];?>
%" data-readOnly="true" data-thickness=".2"/>
                            </div>
                            <div class="widget-data">
                                <div class="widget-big-int"><span class="num-count"><?php echo $_smarty_tpl->tpl_vars['widgets']->value["empty_categories"];?>
</span>%</div>
                                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_widgets_empty_categories']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_widgets_empty_categories']->value;
} else { ?>Empty Categories<?php }?></div>                               
                            </div>                                                        
                        </div> 
                    </div><!-- end col -->
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="widget widget-info widget-padding-sm">                            
                            ...
                            <div class="widget-data">
                                <div class="widget-big-int"><?php echo $_smarty_tpl->tpl_vars['widgets']->value["top_categories"];?>
</div>
                                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_widgets_top_categories']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_widgets_top_categories']->value;
} else { ?>Top Categories<?php }?></div>
...
%" data-readOnly="true" data-thickness=".2"/>
                            ...
                            <div class="widget-data">
                                ...
                                <div class="widget-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_categories_widgets_numbers_of_category']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_widgets_numbers_of_category']->value;
} else { ?>Number of products per category<?php }?></div>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_categories_tables_category_name']->value, 'UTF-8');
                                        ...
                                        <th width="50" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_categories_tables_sub_categories']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_categories_tables_sub_categories']->value, 'UTF-8');
} else { ?>SUB-CATEGORIES<?php }?>
                                        </th>
                                        <th width="50" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_categories_tables_articles']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_categories_tables_articles']->value, 'UTF-8');
} else { ?>ARTICLES<?php }?>
                                        </th>
...
?>
                                       <tr style="border-bottom:2px solid <?php if ($_smarty_tpl->tpl_vars['item']->value->root==1) {?>#95b75d<?php } else { ?>#fea223<?php }?>;border-left: 2px solid <?php if ($_smarty_tpl->tpl_vars['item']->value->root==1) {?>#95b75d<?php } else { ?>#fea223<?php }?>;">
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                               <input type="hidden" name="categoryList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
"/>
                                           ...
                                           <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->category_name;?>
</td>
...
?>
                                                        <li>
                                                            <a href="cpanel/store-update-category-form/<?php echo $_smarty_tpl->tpl_vars['sItem']->value['id_category'];?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value->id_category==$_smarty_tpl->tpl_vars['sItem']->value['id_category']) {?>class="active"<?php }?> style="background-color:<?php echo $_smarty_tpl->tpl_vars['sItem']->value['color'];?>
">
                                                                <?php echo $_smarty_tpl->tpl_vars['sItem']->value['category_name'];?>
                                           ...
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;"><?php echo $_smarty_tpl->tpl_vars['item']->value->count_sub_categories;?>
</td>
                                           <td class="text-center" style="font-weight:700;color:#2a2d34;"><?php echo $_smarty_tpl->tpl_vars['item']->value->count_articles;?>
</td>
                                           <td class="text-center">
                                                <a href="cpanel/store-update-category-form/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_category;?>
" class="btn btn-info" style="padding:7px;border-radius:100%;" title="<?php echo $_smarty_tpl->tpl_vars['item']->value->category_name;?>
">
                                           ...
                                           <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="categoryList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
