<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-04-19 16:59:51
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/slider/slider_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:56845131757166407d35365-21426229%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e629b2f1f99873e138e4aabece77e311ef7b0d26' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/slider/slider_list.tpl',
      1 => 1460547455,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '56845131757166407d35365-21426229',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_57166407eceab7_66044710',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57166407eceab7_66044710')) {function content_57166407eceab7_66044710($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/lib/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="panel panel-default panel-toggled">
                <div class="panel-heading">                                
                    <h3 class="panel-title">
                        <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_panel_create_slider_title']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_panel_create_slider_title']->value, 'UTF-8');
} else { ?>CREATE SLIDER<?php }?>
                    </h3>  
...
echo $_smarty_tpl->tpl_vars['global_slider_form_label_slider_name']->value;
                                ...
                                <input type="text" name="name" value="" placeholder="<?php if (!empty($_smarty_tpl->tpl_vars['global_slider_form_label_slider_name']->value)) {
echo $_smarty_tpl->tpl_vars['global_slider_form_label_slider_name']->value;
...
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <?php if (count($_smarty_tpl->tpl_vars['sliderList']->value)>0) {?>
            <form action="cpanel/update-sliders" method="post" role="form">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <h3 class="panel-title">
                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_panel_slider_list_title']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_panel_slider_list_title']->value, 'UTF-8');
} else { ?>SLIDER LIST<?php }?>
                                ...
                                <div class="form-group pull-left" style="width:400px;margin-right:5px;">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" onclick="location = 'cpanel/slider-list/1/10?q='+document.getElementById('search').value;" class="btn btn-default">
                            ...
                            <table class="table table-bordered table-striped table-actions">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_table_header_slider_name']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_table_header_slider_name']->value, 'UTF-8');
} else { ?>SLIDER NAME<?php }?>
                                        </th>
                                        <th class="text-left">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_table_header_page_name']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_table_header_page_name']->value, 'UTF-8');
} else { ?>PAGE NAME<?php }?>
                                        </th>
                                        <th width="250" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_table_header_creator']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_table_header_creator']->value, 'UTF-8');
} else { ?>CREATOR<?php }?>
                                        </th>
                                        <th width="100" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_table_header_created']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_table_header_created']->value, 'UTF-8');
} else { ?>CREATED<?php }?>
                                        </th>
                                        <th width="100" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_table_header_edit']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_slider_table_header_edit']->value, 'UTF-8');
} else { ?>EDIT<?php }?>
                                        </th>
                                        <th width="100" class="text-center">
...
" />
                                            ...
                                            <td><?php echo $_smarty_tpl->tpl_vars['item']->value->slider_name;?>
</td>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_alert_info']->value, 'UTF-8');
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['global_slider_alert_no_sliders']->value)) {
echo $_smarty_tpl->tpl_vars['global_slider_alert_no_sliders']->value;
} else { ?>There are no sliders.<?php }?>
            </div>
        <?php }?>
    </div><!-- end col -->
</div><!-- end row -->
