<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-27 11:50:07
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/store/warehouses/ajax/add_on_article_list_modal.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57989fef600fe4_63700793',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57989fef600fe4_63700793')) {function content_57989fef600fe4_63700793($_smarty_tpl) {?><style>
    #modal-lyr {
        position: relative;
    }
...
echo $_smarty_tpl->tpl_vars['global_form_select_choose']->value;
                ...
                <?php if (is_object($_smarty_tpl->tpl_vars['whLR']->value)) {?>
                  <div class="form-group pull-right" style="width:300px;margin-right:15px;margin-bottom:0px;">
                    <div class="input-group">  
                      <span class="input-group-addon text-uppercase" style="position: relative;min-width: 210px;">
                        ...
                        <?php if ((((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===1)||((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===3))) {?>
                          <span class="circ-idc" style="color: red;">
                            <i class="fa fa-arrow-down"></i>
                          </span>
                        <?php } elseif ((((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===2)||((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===4))) {?>
                          <span class="circ-idc" style="color: green;">
                            <i class="fa fa-arrow-up" style="position: relative;top: -2px;left: .7px;"></i>
                          </span>
                        <?php } else { ?>
                      ...
                      <?php if ((((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===1)||((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===3))) {?>
                        <input type="text" value="-<?php echo $_smarty_tpl->tpl_vars['whLR']->value->value;
if ((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===1) {?>%<?php }?>" class="form-control text-right" style="font-weight: 700;color: #000;" disabled>
                      <?php } elseif ((((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===2)||((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===4))) {?>
                        <input type="text" value="+<?php echo $_smarty_tpl->tpl_vars['whLR']->value->value;
if ((int) $_smarty_tpl->tpl_vars['whLR']->value->id_action===2) {?>%<?php }?>" class="form-control text-right" style="font-weight: 700;color: #000;" disabled>
                      <?php } else { ?>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_articles_table_header_retail_price']->value, 'UTF-8');
                    ...
                    <th width="100" class="text-center">
                      <?php if (!empty($_smarty_tpl->tpl_vars['store_warehouse_available_article']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_warehouse_available_article']->value, 'UTF-8');
} else { ?>AVAILABLE<?php }?>
                    </th>
...
" class="iw"/>
                      ...
                      <td class="text-center">
                        <div class="form-group" style="width:100%;">
                          <input type="text"  name="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_article;?>
-qty" value="0" class="form-control text-right" style="font-weight: 700;">
                        </div><!-- end form-group -->
                      </td>
                      <td class="text-right">
...
echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
                      ...
                      <td class="text-center">
                        <span style="font-size:1.4em;font-weight:700;color:<?php if ($_smarty_tpl->tpl_vars['item']->value->enabled==1) {?>green<?php } else { ?>red<?php }?>;">
