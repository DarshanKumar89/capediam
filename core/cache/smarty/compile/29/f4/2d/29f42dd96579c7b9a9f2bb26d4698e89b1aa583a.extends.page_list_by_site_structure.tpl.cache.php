<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-10-24 11:20:50
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_list_by_site_structure.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_580dd2728957f0_33315489',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580dd2728957f0_33315489')) {function content_580dd2728957f0_33315489($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row" style="padding: 50px 10px;overflow: auto;">
    <a href="cpanel/unfiled-page-list" id="fs" class="unfiled" title="Unfiled Pages">
        <span class="count">
            <?php echo $_smarty_tpl->tpl_vars['unfiled_pagelist_count']->value;?>
        ...
        <span class="name">
            <?php if (!empty($_smarty_tpl->tpl_vars['global_pages_label_unfiled_pages']->value)) {
echo $_smarty_tpl->tpl_vars['global_pages_label_unfiled_pages']->value;
} else { ?>Unfiled Pages<?php }?>
        </span>
    </a>
    <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['rootStructure']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
?>
        <a href="cpanel/root-page-list/<?php echo $_smarty_tpl->tpl_vars['item']->value->nav_hash;?>
" <?php if ($_smarty_tpl->tpl_vars['item']->value->count<1) {?> onclick="return false;" <?php }?> id="fs" class="<?php if ($_smarty_tpl->tpl_vars['item']->value->count<1) {?>empty<?php } else { ?>classified<?php }?>" title="<?php echo $_smarty_tpl->tpl_vars['item']->value->nav_name;?>
">
            <span class="count">
