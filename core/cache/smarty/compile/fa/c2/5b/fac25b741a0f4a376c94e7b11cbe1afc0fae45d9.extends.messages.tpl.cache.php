<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-26 12:00:03
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/messenger/messages.tpl" */ ?>
<?php /*%%SmartyHeaderCode:485614927579750c3f3b3f3-32999481%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd057067bca34fcf722e2b7f2ff58fbb27355bb7e' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/messenger/messages.tpl',
      1 => 1469528892,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '485614927579750c3f3b3f3-32999481',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_579750c40b2cb8_95729981',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579750c40b2cb8_95729981')) {function content_579750c40b2cb8_95729981($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
" />
    ...
    <?php if ($_smarty_tpl->tpl_vars['redirectForce']->value) {?><meta http-equiv="refresh" content="5;URL=<?php if (!empty($_smarty_tpl->tpl_vars['url']->value)) {
...
<li>
    <a href="cpanel/store" title="Store">
        Store
    </a>
</li>
<li class="active">
    <a href="#" onclick="return false;" title="Messages">
        Messages
    </a>
</li>
...
<div class="row" style="margin-bottom:15px;">
    <div class="col-md-12">
        <a href="<?php if (!empty($_smarty_tpl->tpl_vars['url']->value)) {
echo $_smarty_tpl->tpl_vars['url']->value;
} else {
echo $_smarty_tpl->tpl_vars['referer']->value;
}?>" class="btn btn-default" title="Back">
            <span class="fa fa-arrow-circle-left"></span>
            &nbsp;Click to go back
        </a>
        <?php if ($_smarty_tpl->tpl_vars['redirectForce']->value) {?>
        <p style="margin-top:10px;">
            <strong>NOTICE:</strong>
            If you are not redirected automatically after 5 seconds, click the button.
        </p>
        <?php }?>
    </div>
</div>
    ...
    <div class="col-md-12">
        ...
        <?php if ($_smarty_tpl->tpl_vars['type']->value==1) {?>
            <div class="alert alert-success" role="alert">
                <strong><?php if (!empty($_smarty_tpl->tpl_vars['header']->value)) {
echo $_smarty_tpl->tpl_vars['header']->value;
} else { ?>SUCCESS<?php }?>!</strong> <?php echo $_smarty_tpl->tpl_vars['message']->value;?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['type']->value==2) {?>
            <div class="alert alert-info" role="alert">
                <strong><?php if (!empty($_smarty_tpl->tpl_vars['header']->value)) {
echo $_smarty_tpl->tpl_vars['header']->value;
} else { ?>INFO<?php }?>!</strong> <?php echo $_smarty_tpl->tpl_vars['message']->value;?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['type']->value==3) {?>
            <div class="alert alert-warning" role="alert">
                <strong><?php if (!empty($_smarty_tpl->tpl_vars['header']->value)) {
echo $_smarty_tpl->tpl_vars['header']->value;
} else { ?>WARNING<?php }?>!</strong> <?php echo $_smarty_tpl->tpl_vars['message']->value;?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['type']->value==4) {?>
            <div class="alert alert-danger" role="alert">
                <strong><?php if (!empty($_smarty_tpl->tpl_vars['header']->value)) {
echo $_smarty_tpl->tpl_vars['header']->value;
} else { ?>ERROR<?php }?>!</strong> <?php echo $_smarty_tpl->tpl_vars['message']->value;?>
...
?>
                <div class="alert alert-warning" role="alert">
                    <strong><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</strong>         
                </div>
            <?php } ?>
        <?php }?>
