<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-05 07:34:07
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/drive/drive_upload_file_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:52695343858450a5f549d69-80333435%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04da6d6c8215f0f64d3cd7358cbbf6e8ce8d81aa' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/drive/drive_upload_file_form.tpl',
      1 => 1469707227,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '52695343858450a5f549d69-80333435',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58450a5f83d798_38866253',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58450a5f83d798_38866253')) {function content_58450a5f83d798_38866253($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="#" onclick="return false;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_drive_controls_button_files_upload']->value)) {
...
<div class="row">
    <div class="col-md-12" style="padding: 2px 15px;">
        <form role="form" action="cpanel/insert-file" method="post" enctype="multipart/form-data" class="form-horizontal">                                        
            <div class="form-group">
                <div class="col-md-12">
                    <label>
                        <?php if (!empty($_smarty_tpl->tpl_vars['global_drive_form_label_multiple']->value)) {
echo $_smarty_tpl->tpl_vars['global_drive_form_label_multiple']->value;
} else { ?>Multiple<?php }?>
                    </label>
                    <input type="hidden" name="is_root" value="<?php echo $_smarty_tpl->tpl_vars['settings']->value->is_root;?>
"/>
                    <input type="hidden" name="folder-id" value="<?php echo $_smarty_tpl->tpl_vars['settings']->value->folder_id;?>
"/>
                    <input type="file" name="upload-files[]" multiple class="file" data-preview-file-type="any"/>
                </div>
            </div>
        </form>
    </div>
...
<?php echo '<script'; ?>
 type="text/javascript" src="extensions/cpanel/js/plugins/fileinput/fileinput.min.js"><?php echo '</script'; ?>
>        
<?php echo '<script'; ?>
