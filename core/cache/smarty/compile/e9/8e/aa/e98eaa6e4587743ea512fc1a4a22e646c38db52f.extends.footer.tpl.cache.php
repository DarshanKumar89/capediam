<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-01-25 14:43:31
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5888ab843d7269_26836854',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5888ab843d7269_26836854')) {function content_5888ab843d7269_26836854($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/public/carpedmfashion.com/core/lib/smarty/plugins/modifier.replace.php';
            ...
            <ul>
              <li class="home">
                <a href="/" title="CARPEDM FASHION">
                  <?php if (isset($_smarty_tpl->tpl_vars['btn_home']->value)&&(strlen($_smarty_tpl->tpl_vars['btn_home']->value)>0)) {?>
                    <?php echo $_smarty_tpl->tpl_vars['btn_home']->value;?>
              ...
              <li>
                <a href="#" onclick="return false;">
                  <?php if (isset($_smarty_tpl->tpl_vars['order_finished']->value)&&(strlen($_smarty_tpl->tpl_vars['order_finished']->value)>0)) {?>
                    <?php echo $_smarty_tpl->tpl_vars['order_finished']->value;?>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="alert alert-info" role="alert">
              <p class="text-center text-uppercase">
                <?php if (isset($_smarty_tpl->tpl_vars['order_finished_title']->value)&&(strlen($_smarty_tpl->tpl_vars['order_finished_title']->value)>0)) {?>
                  <strong><?php echo $_smarty_tpl->tpl_vars['order_finished_title']->value;?>
</strong>
                <?php } else { ?>
                  <strong>Vaša objednávka bola úspešne prijatá.</strong>
                <?php }?>
                <?php if (isset($_smarty_tpl->tpl_vars['order_finished_text']->value)&&(strlen($_smarty_tpl->tpl_vars['order_finished_text']->value)>0)) {?>
                  <?php echo $_smarty_tpl->tpl_vars['order_finished_text']->value;?>
...
>
  ...
  <?php if (isset($_smarty_tpl->tpl_vars['order']->value)&&is_object($_smarty_tpl->tpl_vars['order']->value)) {?>
    <!-- Google e-commerce analytics -->
    <?php echo '<script'; ?>
>
      ga('require', 'ecommerce');
      ga('ecommerce:addTransaction', {
        'id': '<?php echo $_smarty_tpl->tpl_vars['order']->value->id_order;?>
',
        'affiliation': 'CARPEDM FASHION',
        'revenue': '<?php echo $_smarty_tpl->tpl_vars['order']->value->total_price;?>
',
        'shipping': '<?php echo $_smarty_tpl->tpl_vars['order']->value->total_shipping;?>
',
        'tax': '<?php echo $_smarty_tpl->tpl_vars['order']->value->total_tax;?>
'
      });
      <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
?>
      ga('ecommerce:addItem', {
        'id': '<?php echo $_smarty_tpl->tpl_vars['order']->value->id_order;?>
',
        'name': '<?php echo $_smarty_tpl->tpl_vars['item']->value->article_name;?>
',
        'sku': '<?php echo mb_strtoupper($_smarty_tpl->tpl_vars['item']->value->sku, 'UTF-8');?>
',
        'category': '',
        'price': '<?php echo $_smarty_tpl->tpl_vars['item']->value->retail_tax_price;?>
',
        'quantity': '<?php echo $_smarty_tpl->tpl_vars['item']->value->qty;?>
'
      });
      <?php } ?>
      ga('ecommerce:send');
