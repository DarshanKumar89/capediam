<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-09-27 08:47:33
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/category/category_create_form.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57ea16059c6127_42153312',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57ea16059c6127_42153312')) {function content_57ea16059c6127_42153312($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="cpanel/store-create-category" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value;
} else { ?>NEW CATEGORY<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value)) {
echo $_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value;
} else { ?>NEW CATEGORY<?php }?>
    </a>
</li>
            ...
            <div class="panel panel-colorful">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title">
                        <?php if (!empty($_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_categories_form_new_category_title']->value, 'UTF-8');
} else { ?>NEW CATEGORY<?php }?>
                    </h3>                     
...
]['category-name']" value="" class="form-control" required>
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-file-text-o"></i>
                                                            </span>
                                                        </div>
...
"></span>
                                                            ...
                                                            <input type="text" name="lang[<?php echo $_smarty_tpl->tpl_vars['lang']->value->id_lang;?>
]['site-title']" value="" class="form-control">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-file-text-o"></i>
                                                            </span>
                                                        </div>
