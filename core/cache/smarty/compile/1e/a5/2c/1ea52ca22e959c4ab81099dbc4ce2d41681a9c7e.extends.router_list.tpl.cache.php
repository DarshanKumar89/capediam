<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-26 12:00:07
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/router/router_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:945908725579750c7bcbc61-70048997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b285a4c62c1b60468ace520da78afdc8e763ccc' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/router/router_list.tpl',
      1 => 1469528894,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '945908725579750c7bcbc61-70048997',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_579750c7cfc060_14245785',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579750c7cfc060_14245785')) {function content_579750c7cfc060_14245785($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="cpanel/router" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_section_router']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_router']->value;
} else { ?>Router<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_router']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_router']->value;
} else { ?>Router<?php }?>
    </a>
</li>
...
echo $_smarty_tpl->tpl_vars['global_router_label_']->value;
} else { ?>CREATE ROUTE<?php }?>
                    </h3>
        ...
        <form action="cpanel/router/update-all" method="post" role="form">
            <div class="panel panel-default">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title">
                        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_router']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_section_router']->value, 'UTF-8');
} else { ?>ROUTE LIST<?php }?>
                ...
                <div class="panel-body panel-body-table">
                    <?php if (count($_smarty_tpl->tpl_vars['routeList']->value)>0) {?>
                        <div class="row">
                            <div class="col-lg-12" style="padding:15px 10px;">
                                <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                    <select class="form-control select" onchange="location = 'cpanel/router/1/'+this.options[this.selectedIndex].value+'/'+<?php echo $_smarty_tpl->tpl_vars['filter']->value;?>
;" required="">
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_table_header_remove']->value, 'UTF-8');
 ...
 $_from = $_smarty_tpl->tpl_vars['routeList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['item']->key => $_smarty_tpl->tpl_vars['item']->value) {
$_smarty_tpl->tpl_vars['item']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['item']->key;
?>
                                        <tr style="border-left: 3px solid <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==2) {?>#3fbae4<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_rule==3) {?>#fea223<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_rule==4) {?>#95b75d<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_rule==5) {?>#b64645<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_rule==6) {?>#410067<?php } else { ?>#000<?php }?>;">
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="routeList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['route-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_route;?>
"/>
                                                <?php echo $_smarty_tpl->tpl_vars['i']->value+1;?>

                                            </td>
                                            <td class="text-center">
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==1) {?><strong>DIRECT</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==2) {?><strong>REWRITE</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==3) {?><strong>REDIRECT</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==4) {?><strong>FORWARD</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==5) {?><strong>KEY</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_rule==6) {?><strong>SCHEMA</strong><?php }?>
                                            </td>
                                            <td class="text-center">
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_request_type==1) {?><strong>GET</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_request_type==2) {?><strong>POST</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_request_type==3) {?><strong>PUT</strong><?php }?>
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->id_request_type==4) {?><strong>DELETE</strong><?php }?>
                                            </td>
                                            <td <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->param_key)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->param_key)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->param_key;?>
                                            ...
                                            <td <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->rw_url)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->rw_url)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->rw_url;?>
...
/<?php if (strlen($_smarty_tpl->tpl_vars['item']->value->path)>0) {
echo $_smarty_tpl->tpl_vars['item']->value->path;
} else {
echo $_smarty_tpl->tpl_vars['item']->value->param_key;
}?>" target="__blank">
...
echo $_smarty_tpl->tpl_vars['item']->value->param_key;
                                            ...
                                            <td <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->ctrl)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->ctrl)) {?>
                                                    <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->ctrl;?>
</strong>
                                                <?php } else { ?>
                                                    <span style="font-size:1.4em;font-weight:700;color:orange;">
                                                        <i class="fa fa-times-circle-o"></i>
                                            ...
                                            <td <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->mth)) {?>class="text-left"<?php } else { ?>class="text-center"<?php }?>>
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->mth)) {?>
                                                   <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->mth;?>
</strong>
                                                <?php } else { ?>
                                                    <span style="font-size:1.4em;font-weight:700;color:orange;">
                                                        <i class="fa fa-times-circle-o"></i>
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="routeList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['active']" <?php if ($_smarty_tpl->tpl_vars['item']->value->active==1) {?>checked=""<?php }?> value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_alert_info']->value, 'UTF-8');
                            ...
                            <?php if (!empty($_smarty_tpl->tpl_vars['global_alert_empty_route_list']->value)) {
echo $_smarty_tpl->tpl_vars['global_alert_empty_route_list']->value;
} else { ?>There are no routes.<?php }?>
                        </div>
                    <?php }?>
                </div><!-- end panel-body -->
                <div class="panel-footer">
