<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-03 13:02:35
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/payment/payment_edit_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18420744035842b45b4a2e09-67255559%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ee6e8039da92d49650adca5d84c19bcaf7cf389' => 
    array (
      0 => '/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/payment/payment_edit_form.tpl',
      1 => 1474276416,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '18420744035842b45b4a2e09-67255559',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5842b45bb658d4_81707897',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5842b45bb658d4_81707897')) {function content_5842b45bb658d4_81707897($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
  <a href="#" onclick="return false;">
    <?php if (isset($_smarty_tpl->tpl_vars['store_section_store']->value)&&(strlen($_smarty_tpl->tpl_vars['store_section_store']->value)>0)) {
...
<li>
  <a href="cpanel/store/delivery-payment/payment">
    <?php if (isset($_smarty_tpl->tpl_vars['store_section_payment']->value)&&(strlen($_smarty_tpl->tpl_vars['store_section_payment']->value)>0)) {
echo $_smarty_tpl->tpl_vars['store_section_payment']->value;
} else { ?>Payment<?php }?>
  </a>
</li>
<li>
...
<li class="active">
  <a href="cpanel/store/delivery-payment/payment/edit/<?php echo $_smarty_tpl->tpl_vars['data']->value->id_payment;?>
" title="<?php echo $_smarty_tpl->tpl_vars['data']->value->payment_name;?>
">
    <?php echo $_smarty_tpl->tpl_vars['data']->value->payment_name;?>
...
<div class="page-title">                    
  <h2>
    <i class="fa fa-usd"></i>&nbsp;
    <?php if (isset($_smarty_tpl->tpl_vars['store_section_payment']->value)&&(strlen($_smarty_tpl->tpl_vars['store_section_payment']->value)>0)) {?>
      <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_payment']->value, 'UTF-8');?>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <form action="cpanel/store/delivery-payment/payment/update" method="post" role="form">
      <input type="hidden" name="payment-id" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->id_payment;?>
"/>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input type="text"
                  name="payment-name"
                  value="<?php if (isset($_smarty_tpl->tpl_vars['data']->value->payment_name)&&(strlen($_smarty_tpl->tpl_vars['data']->value->payment_name)>0)) {
echo $_smarty_tpl->tpl_vars['data']->value->payment_name;
}?>"
                  class="form-control"
                  required
                />
              ...
              <div class="form-group">
                ...
                <input type="text"
                  name="cost"
                  value="<?php if (isset($_smarty_tpl->tpl_vars['data']->value->cost)&&(strlen($_smarty_tpl->tpl_vars['data']->value->cost)>0)) {
echo $_smarty_tpl->tpl_vars['data']->value->cost;
}?>"
                  class="form-control"
                  required
                />
...
" <?php if ($_smarty_tpl->tpl_vars['data']->value->id_currency==$_smarty_tpl->tpl_vars['item']->value->id_currency) {?>selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['item']->value->currency_name;?>
              ...
              <div class="form-group">
                ...
                <textarea name="description" class="form-control" rows="5"><?php if (isset($_smarty_tpl->tpl_vars['data']->value->description)&&(strlen($_smarty_tpl->tpl_vars['data']->value->description)>0)) {
