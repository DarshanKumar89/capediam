<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-06 19:40:40
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/localization/currencies/currencies_edit.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_584706291d3ae9_66068466',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584706291d3ae9_66068466')) {function content_584706291d3ae9_66068466($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li>
    <a href="cpanel/store/localization/currencies/edit/<?php echo $_smarty_tpl->tpl_vars['data']->value->id_currency;?>
" title="<?php echo $_smarty_tpl->tpl_vars['data']->value->currency_name;?>
">
        <?php echo $_smarty_tpl->tpl_vars['data']->value->currency_name;?>
...
<div class="row">
    <div class="col-md-12">
        <form id="currency-form" action="cpanel/store/localization/currencies/update" method="post" role="form">
            <input type="hidden" name="currency-id" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->id_currency;?>
" />
            <div class="panel panel-default">
                <div class="panel-heading ui-draggable-handle">
                    <h3 class="panel-title"><?php echo $_smarty_tpl->tpl_vars['data']->value->currency_name;?>
</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="currency-name" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->currency_name;?>
" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="iso-code" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->iso_code;?>
" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="numeric-iso-code" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->iso_code_num;?>
" class="form-control" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="symbol" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->sign;?>
" class="form-control" required>
                                <span class="help-block">Will appear in Front Office (e.g. $, &amp;euro;, etc.).</span>
                            </div>
                            <div class="form-group">
                                <label>Exchange rate<span style="color:red;">*</span></label>
                                <input type="text" name="exchange-rate" value="<?php echo $_smarty_tpl->tpl_vars['data']->value->conversion_rate;?>
" placeholder="1.000000" class="form-control" required>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="currency-format" class="form-control select">
                                    <option value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->format==1) {?>selected<?php }?>>X0,000.00 (Such as with Dollars)</option>
                                    <option value="2" <?php if ($_smarty_tpl->tpl_vars['data']->value->format==2) {?>selected<?php }?>>0 000,00X (Such as with Euros)</option>
                                    <option value="3" <?php if ($_smarty_tpl->tpl_vars['data']->value->format==3) {?>selected<?php }?>>X0.000,00</option>
                                    <option value="4" <?php if ($_smarty_tpl->tpl_vars['data']->value->format==4) {?>selected<?php }?>>0,000.00X</option>
                                    <option value="5" <?php if ($_smarty_tpl->tpl_vars['data']->value->format==5) {?>selected<?php }?>>X0'000.00</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="decimals" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->decimals) {?>checked<?php }?>>
                                    <span></span>
                                </label><br>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="spacing" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->blank) {?>checked<?php }?>>
                                    <span></span>
                                </label><br>
                            ...
                            <div class="form-group">
                                ...
                                <label class="switch">
                                    <input type="checkbox" name="enable" value="1" <?php if ($_smarty_tpl->tpl_vars['data']->value->active) {?>checked<?php }?>>
                                    <span></span>
                                </label>
                            </div>
                        </div><!-- end col -->
