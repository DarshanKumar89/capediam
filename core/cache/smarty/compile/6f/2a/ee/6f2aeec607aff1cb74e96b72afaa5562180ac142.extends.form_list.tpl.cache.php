<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-04-25 18:22:15
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/form/form_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_571e6057c20390_63843693',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_571e6057c20390_63843693')) {function content_571e6057c20390_63843693($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/lib/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['global_section_form']->value;
        ...
        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_form']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_form']->value;
} else { ?>Forms<?php }?>
    </a>
</li>
...
<div class="page-title">                    
    <h2>
        ...
        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_form']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_form']->value;
} else { ?>Forms<?php }?>&nbsp;<span style="font-size: .7em;color:red;"><sup>Beta</sup></span>
    </h2>
</div>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="btn-group" role="group">
            <button type="button" class="btn btn-info mb-control" data-box="#createForm" role="menuitem">
                <i class="fa fa-plus"></i>
                <span><?php if (!empty($_smarty_tpl->tpl_vars['global_form_create']->value)) {
echo $_smarty_tpl->tpl_vars['global_form_create']->value;
} else { ?>Create Form<?php }?></span>
            </button>
        </div>
    </div><!-- end col -->
</div><!-- end row -->
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        <?php if (!empty($_smarty_tpl->tpl_vars['global_form_list']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_form_list']->value, 'UTF-8');
} else { ?>FORM LIST<?php }?>
                        <?php if (count($_smarty_tpl->tpl_vars['formList']->value)>0) {?>&nbsp;<span class="badge"><?php echo $_smarty_tpl->tpl_vars['pagination_info']->value;?>
</span><?php }?>
                    </h3>
                </div>
                <div class="panel-body panel-body-table">
                    <?php if (count($_smarty_tpl->tpl_vars['formList']->value)>0) {?>
                        <div class="row">
                            <div class="col-lg-12" style="padding:15px 10px;">
                                <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                    <select class="form-control select" onchange="location = 'cpanel/form-list/1/'+this.options[this.selectedIndex].value;">
                        ...
                        <div class="table-responsive" style="border-top:1px solid #E5E5E5;border-bottom:1px solid #E5E5E5;">
                            <table id="formList" class="table table-bordered table-striped table-actions">
                                <thead>
                                    <tr>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_gallery_table_header_publish']->value, 'UTF-8');
                                        ...
                                        <th class="text-center" width="100" style="background-color:red;color:white;">
...
?>
                                        <tr>
                                            <td class="text-center" style="font-weight:700;color:#660000;">
                                                <input type="hidden" name="formList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['form-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_form;?>
"/>
                                                <?php echo $_smarty_tpl->tpl_vars['i']->value+1;?>

                                            </td>
                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->form_name;?>
</td>
                                            <td class="text-left">
                                                {formId=<?php echo $_smarty_tpl->tpl_vars['item']->value->form_hash;?>
}
                                            </td>
                                            <td class="text-left">
                                                <?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['item']->value->form_embed_link;?>

                                            </td>
                                            <td class="text-left">
                                                <?php echo $_smarty_tpl->tpl_vars['item']->value->creator->first_name;?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->creator->last_name;?>

                                            </td>
                                            <td class="text-center"><?php if (!empty($_smarty_tpl->tpl_vars['item']->value->last_modified)) {
echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value->last_modified,"%A, %B %e, %Y");
} else { ?>-<?php }?></td>
                                            <td class="text-center">
                                                <a href="cpanel/form/builder/<?php echo $_smarty_tpl->tpl_vars['item']->value->form_hash;?>
" class="btn btn-primary" style="padding:7px;border-radius:100%;" title="<?php echo $_smarty_tpl->tpl_vars['item']->value->form_name;?>
">
                                            ...
                                            <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="formList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['enabled']" <?php if ($_smarty_tpl->tpl_vars['item']->value->enabled==1) {?>checked=""<?php }?> value="1">
                                                    <span></span>
                                                </label>
                                            </td>
                                            <td class="text-center">
...
<div class="message-box message-box-info animated fadeIn" id="createForm">
    <div class="mb-container">
        <div class="mb-middle">
            <div class="mb-title">
                <?php if (!empty($_smarty_tpl->tpl_vars['global_form_create']->value)) {
echo $_smarty_tpl->tpl_vars['global_form_create']->value;
} else { ?>Create Form<?php }?>
            </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-12 col-xs-12">                                            
                                    ...
                                    <span class="help-block" style="color:#000;">
                                        <?php if (!empty($_smarty_tpl->tpl_vars['global_form_modal_window_form_help_enter_form_name']->value)) {
echo $_smarty_tpl->tpl_vars['global_form_modal_window_form_help_enter_form_name']->value;
} else { ?>Enter a form name.<?php }?>
                                    </span>
                                </div>
                            </div>
                            <div class="form-group">
