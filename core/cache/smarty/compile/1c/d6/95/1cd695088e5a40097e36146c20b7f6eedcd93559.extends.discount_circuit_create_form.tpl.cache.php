<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-05-11 14:04:26
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/discount_circuit/discount_circuit_create_form.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57333beb0392b1_02035658',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57333beb0392b1_02035658')) {function content_57333beb0392b1_02035658($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['global_form_header_color']->value;
                  ...
                  <div class="input-group color" data-color="<?php echo $_smarty_tpl->tpl_vars['rColor']->value;?>
" data-color-format="hex" id="colorpicker">
                  <input type="text" name="color" value="<?php echo $_smarty_tpl->tpl_vars['rColor']->value;?>
" class="form-control"/>
                  <span class="input-group-addon">
                      <i style="background-color:<?php echo $_smarty_tpl->tpl_vars['rColor']->value;?>
"></i>
                  </span>
                  </div>
                </div><!-- end form-group -->
...
echo $_smarty_tpl->tpl_vars['global_form_select_choose']->value;
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12" style="padding: 0;">
                      <label>
                        <?php if (isset($_smarty_tpl->tpl_vars['discount_circuit_warehouse_list']->value)&&(strlen($_smarty_tpl->tpl_vars['discount_circuit_warehouse_list']->value)>0)) {?>
                          <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['discount_circuit_warehouse_list']->value, 'UTF-8');?>
...
?>
                            <option value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_wh;?>
"><?php echo $_smarty_tpl->tpl_vars['item']->value->name;?>
</option>
                          <?php } ?>
                        </select>
                      <?php } else { ?>
                        <div class="alert alert-warning" style="padding: 3.6px 15px;" role="alert">
