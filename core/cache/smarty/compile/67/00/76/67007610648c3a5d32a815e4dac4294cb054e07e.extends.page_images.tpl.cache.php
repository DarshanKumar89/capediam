<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-10-25 23:48:50
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/page/page_images.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_580fd34321c930_41107851',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_580fd34321c930_41107851')) {function content_580fd34321c930_41107851($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/public/carpedmfashion.com/core/lib/smarty/plugins/modifier.truncate.php';
?><!DOCTYPE html>
<html lang="en">
    <head>
...
<li class="active">
    <a href="#" onclick="return false;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_section_pages_images']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_pages_images']->value;
} else { ?>Background image<?php }?>">
        <?php if (!empty($_smarty_tpl->tpl_vars['global_section_pages_images']->value)) {
echo $_smarty_tpl->tpl_vars['global_section_pages_images']->value;
} else { ?>Background image<?php }?>
    </a>
</li>
...
echo $_smarty_tpl->tpl_vars['global_drive_header_folder_structure']->value;
    ...
    <ul class="breadcrumb">
        <li>
            <a href="cpanel/choose-page-image/<?php echo $_smarty_tpl->tpl_vars['actionId']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['pageId']->value;?>
...
<div class="row">
    <div class="col-lg-12">
        <form role="form" action="cpanel/insert-page-image" method="post">
            <input type="hidden" name="action-id" value="<?php echo $_smarty_tpl->tpl_vars['actionId']->value;?>
" />
            <input type="hidden" name="page-id" value="<?php echo $_smarty_tpl->tpl_vars['pageId']->value;?>
" />
...
echo $_smarty_tpl->tpl_vars['global_form_button_save']->value;
            ...
            <?php if (isset($_smarty_tpl->tpl_vars['drive']->value['folders'])&&(is_array($_smarty_tpl->tpl_vars['drive']->value['folders'])&&(count($_smarty_tpl->tpl_vars['drive']->value['folders'])>0))) {?>
              <div id="glr-folders">
                <?php  $_smarty_tpl->tpl_vars['item'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['item']->_loop = false;
...
">
            ...
            <?php }?>
            <?php if (isset($_smarty_tpl->tpl_vars['drive']->value['files'])&&(is_array($_smarty_tpl->tpl_vars['drive']->value['files'])&&(count($_smarty_tpl->tpl_vars['drive']->value['files'])>0))) {?>
