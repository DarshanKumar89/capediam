<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-09-02 07:44:32
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/catalog/article/list/article_long_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57c911c092df13_49519110',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57c911c092df13_49519110')) {function content_57c911c092df13_49519110($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_articles_table_header_article_name']->value, 'UTF-8');
                                        ...
                                        <th width="600" class="text-left">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_articles_table_header_description']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_articles_table_header_description']->value, 'UTF-8');
} else { ?>DESCRIPTION<?php }?>
                                        </th>
                                        <th width="50" class="text-center">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_articles_table_header_index']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_articles_table_header_index']->value, 'UTF-8');
} else { ?>INDEX<?php }?>
                                        </th>
...
"/>
                                            ...
                                            <td class="text-left">
                                                <p style="line-height: 13px !important;"><?php echo $_smarty_tpl->tpl_vars['item']->value->description;?>
</p>
                                            </td>
                                            <td class="text-center">
                                                <span class="circle-indicator <?php if ($_smarty_tpl->tpl_vars['item']->value->color==1) {?>orange<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->color==2) {?>green<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->color==3) {?>blue<?php } else { ?>black<?php }?>">
                                                    <i class="fa fa-bullseye"></i>
                                                </span>
                                            </td>
                                            <td class="text-right" style="font-weight:700;color:#000;">
                                                <?php echo round($_smarty_tpl->tpl_vars['item']->value->retail_price,2);?>
...
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
                                            ...
                                            <td class="text-right" style="font-weight:700;color:#000;">
                                                <?php echo round($_smarty_tpl->tpl_vars['item']->value->tax_price,2);?>
&nbsp;<?php echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
