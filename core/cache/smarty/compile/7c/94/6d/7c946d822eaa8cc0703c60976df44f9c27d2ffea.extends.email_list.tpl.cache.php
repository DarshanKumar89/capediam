<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-05-16 19:24:38
         compiled from "/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/email/email_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1160111717573a1e76b30b44-32199440%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd06ef559775b26d148c1674fca772c50d10bba11' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedm.mozayc.net/core/config/../../app/themes/cpanel/store/email/email_list.tpl',
      1 => 1460547465,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '1160111717573a1e76b30b44-32199440',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_573a1e76c3cfe5_48995855',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573a1e76c3cfe5_48995855')) {function content_573a1e76c3cfe5_48995855($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <div class="col-lg-12">
        <div class="btn-group" role="group">
            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#create-email" role="menuitem">
                <i class="fa fa-plus"></i>
                <span><?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo $_smarty_tpl->tpl_vars['store_']->value;
} else { ?>CREATE EMAIL<?php }?></span>
            </button>
        </div>
    </div><!-- end col -->
</div><!-- end row -->
            ...
            <form action="cpanel/store/statuses/update-all" method="post" role="form">
                <div class="panel panel-default">
                    <div class="panel-heading ui-draggable-handle">
                        <h3 class="panel-title"><?php if (!empty($_smarty_tpl->tpl_vars['store_section_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_']->value, 'UTF-8');
} else { ?>EMAIL LIST<?php }?>&nbsp;<span class="badge"><?php echo count($_smarty_tpl->tpl_vars['emailList']->value);?>
</span></h3>
                        <ul class="panel-controls">
                            <li>
                                <a href="cpanel/store/email/0/0" style="background-color:#000;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_label_all']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_label_all']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/email/0/1" style="background-color:#3fbae4;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/email/0/2" style="background-color:#fea223;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
} else { ?>INVOICE<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            ...
                            <li>
                                <a href="cpanel/store/email/0/3" style="background-color:#95b75d;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/email/0/4" style="background-color:#b64645;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_']->value, 'UTF-8');
} else { ?>DISCOUNT CIRCUIT<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            </li>
                            <li>
...
?>
                                        <tr>
                                            <td class="text-center">
                                               <input type="hidden" name="emailList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['email-id']" value='<?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>
'/>
                                               <?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>

                                           </td>
                                           <td class="text-center">
                                                <span class="circle-indicator center <?php if ($_smarty_tpl->tpl_vars['item']->value->id_widget==1) {?>blue<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_widget==2) {?>orange<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_widget==3) {?>green<?php } elseif ($_smarty_tpl->tpl_vars['item']->value->id_widget==4) {?>red<?php } else { ?>black<?php }?>">
                                                    <i class="fa fa-bullseye"></i>
                                                </span>
                                            </td>
                                            <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->email_name;?>
</td>
                                            <td class="text-left">
                                            ...
                                            <td class="text-left">
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->sender_name)) {?>
                                            ...
                                            <td class="text-left">
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->sender_email)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->sender_email;?>
                                            ...
                                            <td class="text-left">
                                                <?php if (!empty($_smarty_tpl->tpl_vars['item']->value->hide_copy_email)) {?>
                                                    <?php echo $_smarty_tpl->tpl_vars['item']->value->hide_copy_email;?>
                                            ...
                                            <td class="text-center">
                                                <a href="cpanel/store/email/edit/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_email;?>
" class="btn btn-info" style="padding:7px;border-radius:100%;" title="Edit email">
                                                    <i class="fa fa-pencil-square-o" style="position:relative;top:2px;left:4px;"></i>
                                                </a>
                                           </td>
                                           <td class="text-center">
                                                <label class="switch">
                                                    <input type="checkbox" name="emailList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
