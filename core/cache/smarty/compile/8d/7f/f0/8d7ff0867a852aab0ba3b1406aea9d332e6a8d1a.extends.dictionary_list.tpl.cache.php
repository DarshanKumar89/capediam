<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-27 13:24:48
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/dictionary/dictionary_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5681471315798b6203a1750-84907679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf45952341d1daef6afce369b7fce9cf89dbf609' => 
    array (
      0 => '/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/dictionary/dictionary_list.tpl',
      1 => 1469528888,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5681471315798b6203a1750-84907679',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5798b6204805f9_16863365',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5798b6204805f9_16863365')) {function content_5798b6204805f9_16863365($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <?php if (isset($_smarty_tpl->tpl_vars['languageList']->value)&&(is_array($_smarty_tpl->tpl_vars['languageList']->value)&&(count($_smarty_tpl->tpl_vars['languageList']->value)>0))) {?>
      <?php if (isset($_smarty_tpl->tpl_vars['dictionary']->value)&&(is_array($_smarty_tpl->tpl_vars['dictionary']->value)&&(count($_smarty_tpl->tpl_vars['dictionary']->value)>0))) {?>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding:15px 10px;">
                  <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                    <select class="form-control select" onchange="location = 'cpanel/dictionary-list/1/'+this.options[this.selectedIndex].value<?php if (strlen($_smarty_tpl->tpl_vars['keywords']->value)>0) {?>+'?q=<?php echo $_smarty_tpl->tpl_vars['keywords']->value;?>
'<?php }?>;">
                  ...
                  <div class="form-group pull-left" style="width:400px;margin-right:5px;">
                    <div class="input-group">
                      ...
                      <span class="input-group-btn">
                        <button type="button" onclick="location = 'cpanel/dictionary-list/1/20?q='+document.getElementById('search').value;" class="btn btn-default">
...
?>
                                    <tr>
                                        <td class="text-center" style="font-weight:700;color:#660000;">
                                            <input type="hidden" name="itemList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_dictionary;?>
">
                                            <?php echo $_smarty_tpl->tpl_vars['i']->value+1;?>

                                        </td>
                                        <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->section;?>
</td>
                                        <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->block;?>
</td>
...
$_smarty_tpl->tpl_vars['lang']->_loop = true;
?>
                                                <?php if ($_smarty_tpl->tpl_vars['lang']->value->id_lang==$_smarty_tpl->tpl_vars['item']->value->l_key) {?>
                                                    <span class="flag-icon flag-icon-<?php echo $_smarty_tpl->tpl_vars['lang']->value->language_code;?>
" style="width:23px;height:23px;"></span>
                                                <?php }?>
                                            <?php } ?>
                                        </td>
                                        <td class="text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value->t_key;?>
</td>
                                        <td class="text-center">
                                            <?php  $_smarty_tpl->tpl_vars['lang'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['lang']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['languageList']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
" style="position: relative;top: -3px;width:23px;height:23px;"></span>
                                                            ...
                                                            <textarea name="itemList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['translate']" class="form-control" rows="1"><?php echo $_smarty_tpl->tpl_vars['item']->value->t_value;?>
</textarea>
                                                        </div>
                                                    </div>
                                                <?php }?>
                                        ...
                                        <td class="text-center">
                                            <?php if ($_smarty_tpl->tpl_vars['user']->value->rule==1) {?>
                                                <label class="switch">
                                                    <input type="checkbox" name="itemList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['remove']" value="1">
                                                    <span></span>
                                                </label>
                                            <?php } else { ?>
