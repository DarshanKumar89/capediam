<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-07-27 11:48:43
         compiled from "/Users/henrich/Work/SlatyFork/carpedmfashion.com/core/config/../../app/themes/cpanel/store/carts/cart_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_57989f9b4d8029_63710665',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_57989f9b4d8029_63710665')) {function content_57989f9b4d8029_63710665($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
...
echo $_smarty_tpl->tpl_vars['store_section_carts']->value;
    ...
    <div class="page-title">                    
        <h2>
            <i class="fa fa-shopping-cart"></i>&nbsp;
            <?php if (!empty($_smarty_tpl->tpl_vars['store_section_carts']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_carts']->value, 'UTF-8');
} else { ?>Carts<?php }?>&nbsp;
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_section_']->value, 'UTF-8');
                        ...
                        <ul class="panel-controls">
                            <li>
                                <a href="cpanel/store/carts/0/0" style="background-color:#000;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['global_label_all']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_label_all']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/carts/0/1" style="background-color:#3fbae4;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
                            ...
                            <li>
                                <a href="cpanel/store/carts/0/2" style="background-color:#fea223;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>CLOSED<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            ...
                            <li>
                                <a href="cpanel/store/carts/0/3" style="background-color:#95b75d;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>ARCHIVED<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                            ...
                            <li>
                                <a href="cpanel/store/carts/0/4" style="background-color:#b64645;color:#fff;" title="<?php if (!empty($_smarty_tpl->tpl_vars['store_users_label_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_label_']->value, 'UTF-8');
} else { ?>RENEW<?php }?>">
                                    <i class="fa fa-bullseye"></i>
                                </a>
                        ...
                        <div class="row">
                            <div class="col-lg-12" style="padding:15px 10px;">
                                <div class="form-group pull-left" style="width:80px;margin-right:5px;">
                                    <select class="form-control select" onchange="location = 'cpanel/store/carts/<?php echo $_smarty_tpl->tpl_vars['filterA']->value;?>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_table_header_']->value, 'UTF-8');
                                        ...
                                        <th class="text-center" width="70">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_users_table_header_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_table_header_']->value, 'UTF-8');
} else { ?>EXPIRE DATETIME<?php }?>
                                        </th>
                                        <th class="text-center" width="70">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_users_table_header_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_table_header_']->value, 'UTF-8');
} else { ?>EXPIRE (IN MINUTE)<?php }?>
                                        </th>
                                        <th class="text-center" width="50">
                                            <?php if (!empty($_smarty_tpl->tpl_vars['store_users_table_header_']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['store_users_table_header_']->value, 'UTF-8');
...
?>
                                        <tr>
                                            <td class="text-center" style="font-weight:700;color:#2a2d34;">
                                                <input type="hidden" name="carts[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['cart-id']" value="<?php echo $_smarty_tpl->tpl_vars['item']->value->id_cart;?>
"/>
...
echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
                                            ...
                                            <td class="text-center">
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->items>0) {?>
                                                    <button type="button" onclick="showCartItems('<?php echo $_smarty_tpl->tpl_vars['item']->value->secure_key;?>
');" class="btn btn-info btn-sm btn-block">
                                                        <i class="fa fa-eye"></i>
                                                        <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->items;?>
</strong>
                                                    </button>
                                                <?php } else { ?>
                                                    <strong><?php echo $_smarty_tpl->tpl_vars['item']->value->items;?>
                                            ...
                                            <td class="text-center">
                                                <?php if ($_smarty_tpl->tpl_vars['item']->value->is_locked==1) {?>
                                                    <span class="hold">
                                                        <i class="fa fa-link"></i>
                                                    </span>
                                                <?php } else { ?>
                                                    <label class="switch">
                                                        <input type="checkbox" name="carts[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
]['remove']" value="1">
                                                        <span></span>
                                                    </label>
                                                <?php }?>
...
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_alert_info']->value, 'UTF-8');
                ...
                <?php if (!empty($_smarty_tpl->tpl_vars['store_carts_alert_no_carts']->value)) {
echo $_smarty_tpl->tpl_vars['store_carts_alert_no_carts']->value;
} else { ?>There are no carts.<?php }?>
            </div>
        <?php }?>
    </div><!-- end col -->
</div><!-- end row -->
