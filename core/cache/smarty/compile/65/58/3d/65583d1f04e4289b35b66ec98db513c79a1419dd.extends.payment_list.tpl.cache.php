<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-12-08 11:33:19
         compiled from "/var/www/public/carpedmfashion.com/core/config/../../app/themes/cpanel/store/delivery-payment/payment/payment_list.tpl" */ ?>
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_584936f029f140_01083294',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_584936f029f140_01083294')) {function content_584936f029f140_01083294($_smarty_tpl) {?><!DOCTYPE html>
<html lang="en">
    <head>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">           
              ...
              <div class="form-group">
                ...
                <select name="country-id" class="form-control select" data-live-search="true" required>
                  <option value="0"><?php if (isset($_smarty_tpl->tpl_vars['global_form_select_choose']->value)) {
...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <?php if (isset($_smarty_tpl->tpl_vars['paymentList']->value)&&(is_array($_smarty_tpl->tpl_vars['paymentList']->value)&&(count($_smarty_tpl->tpl_vars['paymentList']->value)>0))) {?>
      <form action="cpanel/store/delivery-payment/payment/update-all" method="post" role="form">
        <div class="panel panel-default">
          <div class="panel-heading ui-draggable-handle">
            <span class="badge pull-left"><?php echo count($_smarty_tpl->tpl_vars['paymentList']->value);?>
</span>
          </div>
...
?>
                    <tr>
                      <td class="text-center" style="font-weight:700;color:#2a2d34;">
                        <input type="hidden" name="paymentList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
...
"/>
                      ...
                      <td class="text-center">
                        <span class="flag-icon flag-icon-<?php echo mb_strtolower($_smarty_tpl->tpl_vars['item']->value->country_code, 'UTF-8');?>
...
echo $_smarty_tpl->tpl_vars['item']->value->sign;?>
                      ...
                      <td class="text-center">
                        <a href="cpanel/store/delivery-payment/payment/edit/<?php echo $_smarty_tpl->tpl_vars['item']->value->id_payment;?>
" class="btn btn-info" style="padding:7px;border-radius:100%;" title="<?php echo $_smarty_tpl->tpl_vars['item']->value->payment_name;?>
">
                      ...
                      <td class="text-center">
                        <label class="switch">
                          <input type="checkbox" name="paymentList[<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
          ...
          <div class="panel-footer">
            <button type="submit" class="btn btn-success">
              <i class="fa fa-save"></i>&nbsp;<?php if (isset($_smarty_tpl->tpl_vars['global_form_button_save_changes']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_form_button_save_changes']->value, 'UTF-8');
} else { ?>SAVE CHANGES<?php }?>
            </button>
          </div><!-- end panel-footer -->
    ...
    <?php } else { ?>
      <div class="alert alert-info" role="alert">
        <strong><?php if (isset($_smarty_tpl->tpl_vars['global_alert_info']->value)) {
echo mb_strtoupper($_smarty_tpl->tpl_vars['global_alert_info']->value, 'UTF-8');
} else { ?>INFO<?php }?>!</strong>
        <?php if (isset($_smarty_tpl->tpl_vars['store_delivery_alert_no_payment_methods']->value)) {
echo $_smarty_tpl->tpl_vars['store_delivery_alert_no_payment_methods']->value;
} else { ?>There are no payment methods.<?php }?>
      </div><!-- end alert -->
    <?php }?>
  </div><!-- end col -->
</div><!-- end row -->
