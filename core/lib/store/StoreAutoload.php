...
class StoreAutoload {
  ...
  private function __classMapper()
  {
    ...
    if(is_array($folders) && (count($folders) > 0)) {
      ...
      if(count($this->classes) === 0) {
        throw new Exception('SYSTEM FATAL ERROR STORE CORE NOT FOUND.', 500);
      }
    } else {
      throw new Exception('SYSTEM FATAL ERROR STORE LIBRARY NOT FOUND.', 500);
    }
  }
...
$StoreAutoload = new StoreAutoload(true);