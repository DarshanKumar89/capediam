 ...
 */
class HeurekaCheckedException extends Exception {};

class HeurekaChecked
{
    /**
     ...
     */
    public function __construct($apiKey, $languageId = self::LANGUAGE_SK)
    {
    ...
    {
      if (empty($this->email)) {
        throw new HeurekaCheckedException('Customer email address not set');
      }
      // create URL
